...
$sql_tabla_piscina = "SELECT DISTINCT id_corrida FROM registro_piscina_engorde WHERE id_camaronera = '$camaronera' AND id_piscina = '$piscina' AND estado = 'En proceso'";
...
foreach ($result as $key) {
    ...
    <?php
        ...
        if($cantidad > 0){
            ...
            VALUES ((NOW()),'$camaronera', '$piscina', '$cantidad', '$tipo_alimento', '$encargado', 'Psc', 'Por aprobar', '-------', 1, '$cant_biologo', '$aabb_biologo')";
