...
for ($i = 0; $i < count($_POST['piscinas']); $i++) {
    ...
    if($ps == '17B'){ $ps ='22';}
      ...
      $updater = "
UPDATE proyeccion_alimento SET 
...
INSERT INTO proyeccion_alimento (fecha, alimento, porcentaje, ps, ha, dias, densidad, peso_inicial, crecimiento, peso_proyectado, bw,
