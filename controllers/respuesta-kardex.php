...
$isyet = "
SELECT COUNT(*) AS thisis from proyeccion_alimento 
...
if ($yets < 1){
//INSERT    
    $sql = "INSERT INTO proyeccion_alimento 
        (fecha, alimento, porcentaje, ps, ha, dias, densidad, peso_inicial, crecimiento, peso_proyectado, bw,bw1,bw2,bw3,bw4,bw5,bw6,bw7, 
        lun, mar, mie, jue, vie, sab, dom, total, total_real, porcentaje_real, camaronera, ciclo, intermedio,alimento_proyectado,supervivencia,estado) 
        VALUES 
        ((NOW()), '$yets', '$porcentaje', '$piscina', '$ha', '$dias', '$densidad', '$peso_inicial', '$crecimiento', 
        ...
        '$porcentaje_real', '$camaronera', '$ciclo','$intermedio','$total','$superviv', '2');";
...
if ($yets > 0){
$sql = "UPDATE proyeccion_alimento SET 
    fecha = NOW(), 
    alimento = '$alimento', 
...
$response = array('log' => $log, 'kgha_lunes' => $kgha_dia[1], 'kgha_martes' =>  $kgha_dia[2],'kgha_miercoles' =>  $kgha_dia[3],
