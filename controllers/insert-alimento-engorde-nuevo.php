    ...
    if ($bandera1 == 0 && $bandera2 == 0) {
        ...
        for ($i = 0; $i < count($piscina_1); ++$i) {
            ...
            if ($sobrantes < 0 ){ $bandera3 = 1;} 
                ...
                $sql[$i] = "INSERT INTO `registro_alimentacion_engorde`(`fecha_alimentacion`, `id_camaronera`, `id_piscina`, `id_corrida`, `metodo_alimento`, `id_tipo_alimento`, `id_tipo_alimento_2`, `cantidad`, `cantidad_2`, `tiempo`, `consumo`, `camarones_muertos`, `oxigeno`, `temperatura`, `acumulado_semanal`, `acumulado_total`, `id_usuario`) 
            ...
            //   $query = mysqli_query($conexion, $sql[$i]);
