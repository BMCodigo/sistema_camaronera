                ...
                <div class="container-fluid">
                                    ...
                                    <?php
                                     $_SESSION['llc']=$camaronera;
                                        if ($camaronera == 1) {
                                            ...
                                            $page = $_GET['page'];
                                            echo '<h6> Sistemas de produccion <strong style="color:red;">Darsacom</strong></h6>';
                                            ...
                                            $page = $_GET['page'];
                                            echo '<h6> Sistemas de produccion <strong style="color:red;">Aquacamaron</strong></h6>';
                                            ...
                                            //echo '<h5> JOPISA </h5>';
                                            $page = $_GET['page'];
                                            echo '<h6> Sistemas de produccion <strong style="color:red;">Jopisa</strong></h6>';
                                            ...
                                            $page = $_GET['page'];
                                            echo '<h6> Sistemas de produccion <strong style="color:red;">Aquanatura</strong></h6>';
                                            ...
                                            $page = $_GET['page'];
                                            echo '<h6> Sistemas de produccion <strong style="color:red;">Grupo Camaron</strong></h6>';
                    ...
                    switch ($page) {
                        ...
                        case 'Alimentos':
                            ...
                            if ($camaronera == 1 || $camaronera == 2 || $camaronera == 3 || $camaronera == 4 || $camaronera == 5) {
                                include_once './empresa/proyecciones-alimento.php';
                            } else {
                                echo 'error en el servido ... :(';
                            }
                        ...
                        case 'Nueva-solicitud-biologo':
                            ...
                            if ($camaronera == 1 || $camaronera == 2 || $camaronera == 3 || $camaronera == 4 || $camaronera == 5) {
                                include_once './empresa/nueva-solicitud-biologo.php';
                            } else {
                                echo 'error en el servido ... :(';
                            }
