...
if (isset($_GET['buscar'])) {
    $buscar_datos_fecha = $_GET['buscar'];
    require_once './busqueda.php';
    $desde = date("Y-m-d", strtotime($buscar_datos_fecha . "- 7 days"));
} else if (isset($_GET['siguiente'])) {
    $buscar_datos_fecha_siguiente = $_GET['siguiente'];
    require_once './busqueda.php';
    $desde = date("Y-m-d", strtotime($buscar_datos_fecha . "+ 7 days"));
} else {
    ...
    $sql_aux = "SELECT * FROM `tipo_alimento`";
    $data = $objeto->mostrar($sql_aux);
    foreach ($data as $key) {
        $id_tipo = $key['id_tipo_alimento'];
        $descripcion_alimento = $key['descripcion_alimento'];
        $gramaje_alimento = $key['gramaje_alimento'];
    }

    if(isset( $_POST['search'])){
        $camaronera = $_POST['search'];
    }else{
        $camaronera;
    }
        ...
        <div class="col-12">
            <div class="px-0 pb-2">
                <div style="margin-top: -50px;">
                    <center> <a href="index.php?buscar=<?php echo $desde; ?>" class="enlace btn btn-sm mb-3">

                            << <?php $desde;
                                echo $newDate = date("d-m-y", strtotime($desde)); ?></a> 
                                <a href="index.php?siguiente=<?php echo $fech = date('d-m-y', strtotime($hasta . "+ 1 days")); ?> " class="enlace btn btn-sm mb-3"> <?php $hasta;
                    echo $newDate2 = date("d-m-y", strtotime($hasta)); ?> >> </a> </center>
                </div>

                
                
                <!--div class="col-7 mt" style="margin-left: -11px; margin-top: 10px; width:650px;">

                    <div class="alert alert-danger" role="alert" id="mensaje">
                        Para mostrar el tipo de balanceado dar click sobre el número de <strong> piscina que deseamos visualizar </strong>.
                    </div>
                </div-->
                ...
                <div class="table table-sm table-responsive">
                    ...
                    <div class="" style="background: #028E8C; border: solid 2px white; width:530px; margin:auto;">
                        <h6 class="text-white text-center mt-2 text-uppercase" style="font-size:12px;"> <strong>Alimentacion diaria de piscinas de engorde y precrias en proceso</strong></h6>
                    </div>
                            ...
                            <div class="bd-highlight">
                                <form action="index.php?page=Reporte-semanal" method="POST">
                                    <select class="form-control text-white" name="search" id="camaronera"
                                        ...
                                        <option value="<?php echo $value_camaronera['id_camaronera']; ?>" style="background:#F9F4F4; color:black;">
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <!-- numero de piscina -->
                                        <td class="align-middle text-center" data-toggle="modal" data-target=".bd-example-modal-sm<?php echo $psm; ?>" style="border: 1px solid #40497C">
                                        ...
                                        <td class="align-middle text-center" style="border: 1px solid #40497C">
                                            ...
                                            #incremento anterior
                                            $dx_21 = date('Y-m-d', strtotime($hasta . "- 21 days"));
                                            $sql = "SELECT MAX(incremento) AS total FROM registro_muestreo WHERE id_piscina = '$aux' AND id_camaronera = '$camaronera' AND id_corrida = '$aux_corrida' AND fecha_muestreo = '$dx_21'";
                                            $data = $objeto->mostrar($sql);
                                        ...
                                        <td class="align-middle text-center" style="border: 1px solid #40497C">
                                            ...
                                            #incremento anterior
                                            $dx_14 = date('Y-m-d', strtotime($hasta . "- 14 days"));
                                        ...
                                        <!--td class="align-middle text-center" style="border: 1px solid #40497C">
                                            ...
                                            /*
                                            $f = date('Y-m-d', $dia_siete);
                                            $sql = "SELECT MAX(peso) as total FROM `registro_muestreo` WHERE id_piscina = '$aux' AND id_camaronera = '$camaronera' AND id_corrida = '$aux_corrida' AND fecha_muestreo = '$f'";
                                            $data = $objeto->mostrar($sql);
                                            ...
                                            */
                                            ...
                                            /*if ($densidad > 0) {
                                                ...
                                                $r1 = $acum * 2.2 . '</br>';
                                                $r2 = ($densidad * $peso1 * 0.0022) * $ha . '</br>';
                                                $r3 = $raleo . '</br>';
                                                $r4 = $r2 + $r3 . '</br>';
                                                $factor = $r1 / $r4;
                                            } else {
                    ...
                    <div class="scroll">
                        <table class="table table-sm tab table-striped col-7">
                            ...
                            <tbody>
                                ...
                                $sql_precria = "SELECT DISTINCT id_precria, hectareas, identificacion  FROM registro_piscina_precria WHERE estado != 'Cosechado'  AND id_camaronera = '$camaronera' ORDER BY id_precria ASC";
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center" style="border: 1px solid #40497C">
                                            <span class="text-secondary text-xs font-weight-bold">
                                                <?php 
                                                    ...
                                                    if($value_pre['id_precria']== 31){
                                                        echo '3A';
                                                        $aux = $value_pre['id_precria'];
                                                    }else if($value_pre['id_precria'] == 91){
                                                        echo '9B';
                                                        $aux = $value_pre['id_precria'];
                                                    }else{
                                                        echo $aux = $value_pre['id_precria'];
                                                    }
                                                ?>
                                            </span>
                                        ...
                                        <td class="align-middle text-center" style="border: 1px solid #40497C">
                                            <span class="text-secondary text-xs font-weight-bold"><?php echo $value_pre['hectareas']; ?></span>
                                        </td>

                                        <?php

                                        $sql = "SELECT MAX(fecha_alimentacion) fecha_alimentacion FROM registro_alimentacion_precria WHERE id_precria = '$pre' AND id_camaronera = '$camaronera'";
                                        $data = $objeto->mostrar($sql);
                                        foreach ($data as $xt) {
                                            ...
                                            $sql = "SELECT id_tipo_alimento FROM registro_alimentacion_precria WHERE  id_precria = '$pre' AND id_camaronera = '$camaronera' AND fecha_alimentacion = '$fch'";
                                            $data = $objeto->mostrar($sql);
                                            foreach ($data as $xt) {
                                        ...
                                        <td class="align-middle text-center" style="border: 1px solid #40497C">
                                            ...
                                            $sql_uno = "SELECT SUM(cantidad + cantidad_2) as total FROM registro_alimentacion_precria WHERE fecha_alimentacion = '$uno' AND id_precria = '$aux' AND id_camaronera = '$camaronera' AND identificacion = '$iden'";
                                            $data_uno = $objeto->mostrar($sql_uno);
                                            foreach ($data_uno as $x) {
                                        ...
                                        <td class="align-middle text-center" style="border: 1px solid #40497C">
                                            ...
                                            $sql_semanal = "SELECT SUM(cantidad + cantidad_2) AS total FROM registro_alimentacion_precria WHERE id_precria = '$aux' AND fecha_alimentacion >= '$desde' AND fecha_alimentacion <= '$hasta' AND id_camaronera = '$camaronera' AND identificacion = '$iden'";
                                            $data_semanal = $objeto->mostrar($sql_semanal);
                                        ...
                                        <td class="align-middle text-center" style="border: 1px solid #40497C">
                                            ...
                                            $sql_acumulado = "SELECT SUM(cantidad + cantidad_2) AS total FROM `registro_alimentacion_precria` WHERE id_precria = '$aux' AND id_camaronera = '$camaronera' AND identificacion = '$iden'";
                                            $data_acumulado = $objeto->mostrar($sql_acumulado);
                                        ...
                                        <td class="align-middle text-center" style="border: 1px solid #40497C">
                                            ...
                                            $sql_dias = "SELECT fecha_siembra FROM `registro_piscina_precria` WHERE id_precria = '$aux' AND estado != 'Cosechado' AND id_camaronera = '$camaronera' AND identificacion = '$iden'";
                                            $data_dias = $objeto->mostrar($sql_dias);
                    ...
                    <div class="" style="background: #028E8C; border: solid 2px white; width:350px; margin-left:-12px;">
                        ...
                        <table class="table table-sm tab table-striped mt-5" style="margin-left: -10px;">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT t2.descripcion_alimento AS descripcion, t2.gramaje_alimento AS gramaje, t2.id_tipo_alimento AS id FROM registro_alimentacion_engorde t1, tipo_alimento t2 WHERE t1.id_camaronera = '$camaronera' AND t1.fecha_alimentacion BETWEEN '$desde'AND '$hasta' AND (t1.id_tipo_alimento = t2.id_tipo_alimento OR t1.id_tipo_alimento_2 = t2.id_tipo_alimento) AND t2.descripcion_alimento != 'balanceado' GROUP BY t2.descripcion_alimento, t2.gramaje_alimento;";
                                $data = $objeto->mostrar($sql);

                                foreach ($data as $a) {
                                    $id = $a['id'];
                                    $tipo_alimento = $a['descripcion'];
                                    $valor_gramaje = $a['gramaje'];
                                ?>

                                    <tr style="border: 1px solid #40497C;">

                                        <td class="text-center" style="border: solid 2px #343a40;">

                                            <span class="text-secondary text-xs font-weight-bold"><?php echo $a['descripcion'] . ' ' . $a['gramaje']; ?>
                                            </span>
                                        ...
                                        <td class="align-middle text-center" style="border: solid 2px #343a40;">
                                            ...
                                            $sql= "SELECT t.tipo, SUM(t.can) AS total FROM (SELECT  * FROM (SELECT alim.descripcion_alimento AS tipo, SUM(ti.cantidad) AS can FROM registro_alimentacion_engorde ti left join tipo_alimento as alim on alim.id_tipo_alimento=ti.id_tipo_alimento WHERE id_camaronera = '$camaronera'  AND fecha_alimentacion = '$uno' AND alim.descripcion_alimento='$tipo_alimento' and alim.gramaje_alimento='$valor_gramaje' GROUP BY alim.descripcion_alimento) t_1 UNION (SELECT  alim.descripcion_alimento AS tipo, SUM(ti.cantidad_2) AS can FROM registro_alimentacion_engorde ti left join tipo_alimento as alim on alim.id_tipo_alimento=ti.id_tipo_alimento_2 WHERE id_camaronera = '$camaronera' AND fecha_alimentacion = '$uno' AND alim.descripcion_alimento='$tipo_alimento' and alim.gramaje_alimento='$valor_gramaje' GROUP BY alim.descripcion_alimento)) t GROUP BY t.tipo;";
                                            $data = $objeto->mostrar($sql);
                                            if (count($data) > 0) {
                                                foreach ($data as $a) {
                                                    $l = $a['total'] / 25;
                                        ...
                                        <td class="align-middle text-center" style="border: solid 2px #343a40;">
                                            ...
                                            $sql= "SELECT t.tipo, SUM(t.can) AS total FROM (SELECT  * FROM (SELECT alim.descripcion_alimento AS tipo, SUM(ti.cantidad) AS can FROM registro_alimentacion_engorde ti left join tipo_alimento as alim on alim.id_tipo_alimento=ti.id_tipo_alimento WHERE id_camaronera = '$camaronera'  AND fecha_alimentacion = '$dos' AND alim.descripcion_alimento='$tipo_alimento' and alim.gramaje_alimento='$valor_gramaje' GROUP BY alim.descripcion_alimento) t_1 UNION (SELECT  alim.descripcion_alimento AS tipo, SUM(ti.cantidad_2) AS can FROM registro_alimentacion_engorde ti left join tipo_alimento as alim on alim.id_tipo_alimento=ti.id_tipo_alimento_2 WHERE id_camaronera = '$camaronera' AND fecha_alimentacion = '$dos' AND alim.descripcion_alimento='$tipo_alimento' and alim.gramaje_alimento='$valor_gramaje' GROUP BY alim.descripcion_alimento)) t GROUP BY t.tipo;";
                                            $data = $objeto->mostrar($sql);
                                            if (count($data) > 0) {
                                                foreach ($data as $a) {
                                                    $m = $a['total'] / 25;
                                        ...
                                        <td class="align-middle text-center" style="border: solid 2px #343a40;">
                                            ...
                                            $sql= "SELECT t.tipo, SUM(t.can) AS total FROM (SELECT  * FROM (SELECT alim.descripcion_alimento AS tipo, SUM(ti.cantidad) AS can FROM registro_alimentacion_engorde ti left join tipo_alimento as alim on alim.id_tipo_alimento=ti.id_tipo_alimento WHERE id_camaronera = '$camaronera'  AND fecha_alimentacion = '$tres' AND alim.descripcion_alimento='$tipo_alimento' and alim.gramaje_alimento='$valor_gramaje' GROUP BY alim.descripcion_alimento) t_1 UNION (SELECT  alim.descripcion_alimento AS tipo, SUM(ti.cantidad_2) AS can FROM registro_alimentacion_engorde ti left join tipo_alimento as alim on alim.id_tipo_alimento=ti.id_tipo_alimento_2 WHERE id_camaronera = '$camaronera' AND fecha_alimentacion = '$tres' AND alim.descripcion_alimento='$tipo_alimento' and alim.gramaje_alimento='$valor_gramaje' GROUP BY alim.descripcion_alimento)) t GROUP BY t.tipo;";
                                            $data = $objeto->mostrar($sql);
                                            if (count($data) > 0) {
                                                foreach ($data as $a) {
                                                    $mi = $a['total'] / 25;
                                        ...
                                        <td class="align-middle text-center" style="border: solid 2px #343a40;">
                                            ...
                                            $sql= "SELECT t.tipo, SUM(t.can) AS total FROM (SELECT  * FROM (SELECT alim.descripcion_alimento AS tipo, SUM(ti.cantidad) AS can FROM registro_alimentacion_engorde ti left join tipo_alimento as alim on alim.id_tipo_alimento=ti.id_tipo_alimento WHERE id_camaronera = '$camaronera'  AND fecha_alimentacion = '$cuatro' AND alim.descripcion_alimento='$tipo_alimento' and alim.gramaje_alimento='$valor_gramaje' GROUP BY alim.descripcion_alimento) t_1 UNION (SELECT  alim.descripcion_alimento AS tipo, SUM(ti.cantidad_2) AS can FROM registro_alimentacion_engorde ti left join tipo_alimento as alim on alim.id_tipo_alimento=ti.id_tipo_alimento_2 WHERE id_camaronera = '$camaronera' AND fecha_alimentacion = '$cuatro' AND alim.descripcion_alimento='$tipo_alimento' and alim.gramaje_alimento='$valor_gramaje' GROUP BY alim.descripcion_alimento)) t GROUP BY t.tipo;";
                                            $data = $objeto->mostrar($sql);
                                            if (count($data) > 0) {
                                                foreach ($data as $a) {
                                                    $j = $a['total'] / 25;
                                        ...
                                        <td class="align-middle text-center" style="border: solid 2px #343a40;">
                                            ...
                                            $sql= "SELECT t.tipo, SUM(t.can) AS total FROM (SELECT  * FROM (SELECT alim.descripcion_alimento AS tipo, SUM(ti.cantidad) AS can FROM registro_alimentacion_engorde ti left join tipo_alimento as alim on alim.id_tipo_alimento=ti.id_tipo_alimento WHERE id_camaronera = '$camaronera'  AND fecha_alimentacion = '$cinco' AND alim.descripcion_alimento='$tipo_alimento' and alim.gramaje_alimento='$valor_gramaje' GROUP BY alim.descripcion_alimento) t_1 UNION (SELECT  alim.descripcion_alimento AS tipo, SUM(ti.cantidad_2) AS can FROM registro_alimentacion_engorde ti left join tipo_alimento as alim on alim.id_tipo_alimento=ti.id_tipo_alimento_2 WHERE id_camaronera = '$camaronera' AND fecha_alimentacion = '$cinco' AND alim.descripcion_alimento='$tipo_alimento' and alim.gramaje_alimento='$valor_gramaje' GROUP BY alim.descripcion_alimento)) t GROUP BY t.tipo;";
                                            $data = $objeto->mostrar($sql);
                                            if (count($data) > 0) {
                                                foreach ($data as $a) {
                                                    $v = $a['total'] / 25;
                                        ...
                                        <td class="align-middle text-center" style="border: solid 2px #343a40;">
                                            ...
                                            $sql= "SELECT t.tipo, SUM(t.can) AS total FROM (SELECT  * FROM (SELECT alim.descripcion_alimento AS tipo, SUM(ti.cantidad) AS can FROM registro_alimentacion_engorde ti left join tipo_alimento as alim on alim.id_tipo_alimento=ti.id_tipo_alimento WHERE id_camaronera = '$camaronera'  AND fecha_alimentacion = '$seis' AND alim.descripcion_alimento='$tipo_alimento' and alim.gramaje_alimento='$valor_gramaje' GROUP BY alim.descripcion_alimento) t_1 UNION (SELECT  alim.descripcion_alimento AS tipo, SUM(ti.cantidad_2) AS can FROM registro_alimentacion_engorde ti left join tipo_alimento as alim on alim.id_tipo_alimento=ti.id_tipo_alimento_2 WHERE id_camaronera = '$camaronera' AND fecha_alimentacion = '$seis' AND alim.descripcion_alimento='$tipo_alimento' and alim.gramaje_alimento='$valor_gramaje' GROUP BY alim.descripcion_alimento)) t GROUP BY t.tipo;";
                                            $data = $objeto->mostrar($sql);
                                            if (count($data) > 0) {
                                                foreach ($data as $a) {
                                                    $s = $a['total'] / 25;
                                        ...
                                        <td class="align-middle text-center" style="border: solid 2px #343a40;">
                                            ...
                                            $sql= "SELECT t.tipo, SUM(t.can) AS total FROM (SELECT  * FROM (SELECT alim.descripcion_alimento AS tipo, SUM(ti.cantidad) AS can FROM registro_alimentacion_engorde ti left join tipo_alimento as alim on alim.id_tipo_alimento=ti.id_tipo_alimento WHERE id_camaronera = '$camaronera'  AND fecha_alimentacion = '$siete' AND alim.descripcion_alimento='$tipo_alimento' and alim.gramaje_alimento='$valor_gramaje' GROUP BY alim.descripcion_alimento) t_1 UNION (SELECT  alim.descripcion_alimento AS tipo, SUM(ti.cantidad_2) AS can FROM registro_alimentacion_engorde ti left join tipo_alimento as alim on alim.id_tipo_alimento=ti.id_tipo_alimento_2 WHERE id_camaronera = '$camaronera' AND fecha_alimentacion = '$siete' AND alim.descripcion_alimento='$tipo_alimento' and alim.gramaje_alimento='$valor_gramaje' GROUP BY alim.descripcion_alimento)) t GROUP BY t.tipo;";
                                            $data = $objeto->mostrar($sql);
                                            $data = $objeto->mostrar($sql);
                                            if (count($data) > 0) {
                                                foreach ($data as $a) {
                                        ...
                                        <td class="align-middle text-center" style="border: solid 2px #343a40;">
                                            ...
                                            $suma = $l + $m + $mi + $j + $v + $s + $d;
                                            ?>
                                            <span class="text-secondary text-xs font-weight-bold"><?php echo intval($suma); ?></span>
                                        </td>
                                    </tr>
                                <?php } ?>
                                ...
                                <tr class="bg-dark text-white" style="border: solid 2px #343a40;">
                                    ...
                                    <td class="text-center" style="background: #555557; border: solid 2px #343a40; color:white;">
                                        <span class="text-center"><?php echo  $rl + $rm + $rmi + $rj + $rv + $rs + $rd ?></span>
                                    </td>
                                <?php } ?>
                                </tr>
                            </tbody>
...
<style>
    /* Estilo normal del enlace */
.enlace {
    color: white; /* Color del texto del enlace */
    text-decoration: none; /* Quitar la subrayado por defecto del enlace */
    background:#b15478;
}

/* Estilo cuando el cursor pasa sobre el enlace */
.enlace:hover {
    /*color: #f00; /* Cambiar el color del texto del enlace cuando el cursor esté sobre él */
    color: #b15478; /* Cambiar el color del texto del enlace cuando el cursor esté sobre él */
    background:white;
}
