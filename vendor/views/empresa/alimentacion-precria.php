                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-lg-6">
                                <div class="input-group">
                                      ...
                                      <input type="text" class="form-control" name="fechaActual" id="fechaActualpre" style="background: none;">
                                            ...
                                            <td>
                                                <div class="container">
                                                    ...
                                                    <select class="select" class="select" name="observacion[]" id="observacion">
                                                            ...
                                                            <option class="text-center" value="No se alimenta o se baja dieta por Oxigenacion">Oxigenacion</option>
                                                            <option class="text-center" value="No se alimenta o se baja dieta por Transferencia">Transferencia</option>
                                                        </select>
                                                    </div>
