                    ...
                    <div class="mb-20">
                        <form onsubmit="return poblacion()" action="../controllers/insert-poblacion.php" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 col-lg-7">
                                    <div class="input-group">
                                        <input type="date" class="form-control" name="fechaActualModal" id="fechaActual" readonly style="background: none;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 col-lg-7">
                                    <div class="input-group">
                                        <input type="number" step="any" class="form-control" id="cantidad_animales" name="cantidad_animales" value="100000">
