...
<div class="row" style="margin: auto;">
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body" style="margin:auto">
                <div class="mb-20">
                    <form class="container" onsubmit="return intermedio()" action="../controllers/insert-peso.php" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 col-lg-7">
                                <div class="input-group">
                                    <input type="date" class="form-control" name="fechaActual" id="fechaActualpoblacional" readonly style="background: none;">
                                </div>
                            </div>
                        </div>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_1" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 2) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_2" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 3) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_3" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_4" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                    <?php } ?>
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_5" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_6" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                    <?php } ?>
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_7" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                    <?php } ?>
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_8" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                    <?php } ?>
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_9" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                    <?php } ?>
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_10" step="any" value="0.0">
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_11" step="any" value="0.0">
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_12" step="any" value="0.0">
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_13" step="any" value="0.0">
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_14" step="any" value="0.0">
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_15" step="any" value="0.0">
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_16" step="any" value="0.0">
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_17" step="any" value="0.0">
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_64" step="any" value="0.0">
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_18" step="any" value="0.0">
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_19" step="any" value="0.0">
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_20" step="any" value="0.0">
                                ...
                                <tr class="text-center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" min="0" max="40" class="inputs text-center" name="peso[]" id="peso_21" step="any" value="0.0">
                        ...
                        <center><button class="btn btn-danger btn-sm text-light mt-1" id="add-peso-intermedi" type="submit">guardar datos de peso intermedio</button></center>
                    </form>
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body" style="margin:auto">
                <div class="mb-20">
                    <form class="container" onsubmit="return muestreo()" action="../controllers/insert-muestreo.php" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-lg-6">
                                <div class="input-group">
                                    <input type="date" class="form-control" name="fechaActual" id="fechaActualmuestreo" readonly style="background: none;">
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-sm table-hover mt-2 table-bordered" style="margin-top:-15px; margin-left: -31px; width:290px">
                            <div class="alert alert-danger alert-dismissible fade show text-center" role="alert" id="nombre-form-alert" style="display: none;">
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 1) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_1" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 2) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_2" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 3) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_3" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 4) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_4" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 5) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_5" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 6) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_6" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 7) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_7" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 8) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_8" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 9) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_9" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 10) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_10" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 11) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_11" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 12) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_12" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 13) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_13" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 14) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_14" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 15) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_15" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 16) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_16" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 17) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_17" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 22) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_64" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 18) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_18" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 19) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_19" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 20) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_20" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tr class="text-center">
                                    ...
                                    if ($ps == 21) { ?>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="densidad[]" id="densidad_21" step="any" value="0.0">
                                                </div>
                                            </div>
                                        </td>
                        ...
                        <center><button class="btn btn-danger btn-sm text-light mt-1" id="add-mueste" type="submit">guardar datos de peso domingo</button></center>
                    </form>
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body" style="margin:auto">
                <div class="mb-20">
                    <form class="container" onsubmit="return muestreo()" action="../controllers/insert-larva-estimado.php" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 col-lg-7">
                                <div class="input-group">
                                    <input type="date" class="form-control" name="fechaActual"  readonly style="background: none;" value="<?php echo $fecha_actual; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-sm table-hover mt-2 table-bordered" style="margin-top:-15px; width:50px">
                            <div class="alert alert-danger alert-dismissible fade show text-center" role="alert" id="nombre-form-alert" style="display: none;">
                                ...
                                <tr class="text-center">
                                    ...
                                    foreach ($data as $x) { ?>
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" readonly step="any" name="precria[]" id="precria" step="any" value="<?php echo $x['id_precria'] ?>">
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="container">
                                                <div class="input-group input-group-static d-flex justify-content-center">
                                                    <input type="number" class="inputdens text-center" name="estimado[]" id="estimado" step="any" value="0.0">
                                                    <input type="hidden" name="secuencial[]" value="<?php echo $x['secuencial']; ?>">
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <center><button class="btn btn-danger btn-sm text-light mt-1" id="add-mueste" type="submit">guardar datos de estimacion</button></center>
                    </form>
