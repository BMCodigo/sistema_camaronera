    ...
    <div class="modal fade bd-example-modal-sm<?php echo $aux_pre; ?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="container text-danger mt-3">
                    ...
                    <h6><?php   echo 'Precria #'.$pre; echo $c_pre; ?></h6>
                ...
                <div class="modal-body text-justify text-left" style="margin-top: -12px;">
                    ...
                    $sql = "SELECT id_tipo_alimento, fecha_alimentacion FROM registro_alimentacion_precria WHERE id_precria = '$pre' AND id_camaronera = '$camaronera' AND identificacion = '$c_pre' AND fecha_alimentacion BETWEEN '$desde' AND '$fechaActual' ORDER BY fecha_alimentacion";
