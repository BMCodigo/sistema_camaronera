                                                ...
                                                <table class="table table-bordered table-sm table-hover" id="tabla">
                                                    ...
                                                    <div class="container">
                                                        <td class="text-center text-white" style="background: #404e67;">
                                                            <strong>
                                                                <?php number_format($promedio_ha,2); ?>
                                                            </strong>
                                                        </td>
                                                        <td class="text-center text-white" style="background: #404e67;">
                                                            <strong>
                                                                <?php 
                                                                    ...
                                                                    $promedio_anim_semb;
                                                                    $promedio_anim_semb = number_format(str_replace(',', '.', $promedio_anim_semb),0);
                                                                ?>
                                                            </strong>
                                                        </td>
                                                        <td class="text-center text-white" style="background: #404e67;">
                                                            <strong>
                                                                <?php number_format($promedio_pesoSiembra,2); ?>
                                                            </strong>
                                                        </td>
                                                        <td class="text-center text-white" style="background: #404e67;">
                                                            <strong>
                                                                <?php number_format($promedio_dias,0); ?>
                                                            </strong>
                                                        </td>
                                                        <td class="text-center text-white" style="background: #404e67;">
                                                            <strong>
                                                                <?php number_format($promedio_pesoActual,2); ?>
                                                            </strong>
                                                        </td>
                                                        <td class="text-center text-white" style="background: #404e67;">
                                                            <strong>
                                                                <?php number_format($promedio_grDia,2); ?>
                                                            </strong>
                                                        </td>
                                                        <td class="text-center text-white" style="background: #404e67;">
                                                            <strong>
                                                                <?php  number_format($promedio_raleo,2); ?>
                                                            </strong>
                                                        </td>
                                                        <td class="text-center text-white" style="background: #404e67;">
                                                            <strong>
                                                                <?php  number_format($promedio_lbsHa,2); ?>
                                                            </strong>
                                                        </td>
                                                        <td class="text-center text-white" style="background: #404e67;">
                                                            <strong>
                                                                <?php  number_format($promedio_fcv,2); ?>
                                                            </strong>
                                                        </td>
                                                        <td class="text-center text-white" style="background: #404e67;">
                                                            <strong>
                                                                <?php  number_format($promedio_costoBalkgHa,2); ?>
                                                            </strong>
                                                        </td>
                                                        <td class="text-center text-white" style="background: #404e67;">
                                                            <strong>
                                                                <?php  number_format($promedio_costoLarvaHa,2); ?>
                                                            </strong>
                                                        </td>
                                                        <td class="text-center text-white" style="background: #404e67;">
                                                            <strong>
                                                                <?php  number_format($promedio_costoIndHaDia,2); ?>
                                                            </strong>
                                                        </td>
                                                        <td class="text-center text-white" style="background: #404e67;">
                                                            <strong>
                                                                <?php  number_format($promedio_balaPorLibras,2); ?>
                                                            </strong>
                                                        </td>
                                                        <td class="text-center text-white" style="background: #404e67;">
                                                            <strong>
                                                                <?php  number_format($promedio_larvaPorLibras,2); ?>
                                                            </strong>
                                                        </td>
                                                        <td class="text-center text-white" style="background: #404e67;">
                                                            <strong>
                                                                <?php  number_format($promedio_indPorLibras,2); ?>
                                                            </strong>
                                                        </td>
                                                        <td class="text-center text-white" style="background: #404e67;">
                                                            <strong>
                                                                <?php  number_format($promedio_totalPorLibras,2); ?>
                                                            </strong>
                                                        </td>
                                                        <td class="text-center text-white" style="background: #404e67;">
                                                            <strong>
                                                                <?php  number_format($promedio_venta,2); ?>
                                                            </strong>
                                                        </td>
                                                        <td class="text-center text-white" style="background: #404e67;">
                                                            <strong>
                                                                <?php  number_format($promedio_rentabilidad,2); ?>
                                                            </strong>
                                                        </td>
                                                    </div>
