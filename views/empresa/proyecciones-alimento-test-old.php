<?php
    ...
    $sql = " select * from proyeccion_alimento WHERE fecha >='$desde' AND fecha <='$hasta' AND camaronera= '$camaronera' AND estado = '1' ;"; 
...
?>
                        ...
                        <table class="table table-sm tab table-striped">
                            <thead>
                                 ...
                                 <th  style="background: white; color:black; border: solid 2px #343a40;margin:auto;" colspan="2"><b>PROYECTADO</b></th>
                                   <th  style="background: white; color:black; border: solid 2px #343a40;margin:auto;" colspan="3"><b>REFERENCIAS</b></th>
                                 </tr>
 ...
 <th style="background: #404e67; color:white; border: solid 2px #343a40;">
  ...
  <input type="number" style = "width:100%;" class=" form-control" id="<?php echo 'cantidades[]'.$value['id_piscina'];?>" name="<?php echo 'cantidades[]'.$value['id_piscina'];?>" step="any"   placeholder="0.00" style="width:85px;" value="<?echo $datosatomicos[0]['crecimiento']; ?>">
...
";
                                        ...
                                        ?>
                                                ...
                                                <input type="number" style = "width:100%;" class=" form-control" id="<?php echo 'densidadesfijo[]'.$value['id_piscina'];?>" name="<?php echo 'densidadesfijo[]'.$value['id_piscina'];?>" step="any" readonly placeholder="0.00" style="width:85px;" 
                                        ...
                                        ?>
                                                <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'cantidadfijo[]'.$key['id_piscina'];?>">
                                                <input type="number" style = "width:100%;" class=" form-control" id="<?php echo 'densidadesfijo[]'.$value['id_piscina'];?>" name="<?php echo 'densidadesfijo[]'.$value['id_piscina'];?>" step="any" readonly placeholder="0.00" style="width:85px;" value ="<?php  if ($densidad == 0 || $densidad == null) {
                                                                                                        echo $densidad = 0;
                                                                                                    } else {
                                        ...
                                        ?>
                                                ...
                                                <td class="align-middle text-center" style="border: solid 0px #343a40;display:none;">
                                              <?php   
                            ...
                            <tbody>
                             ...
                             <td class="align-middle text-center" style="border: 1px solid #40497C;width:12%;">
                                        ...
                                        ?>
                                           ...
                                           <td class="align-middle text-center" style="border: 1px solid #40497C;" id="<?php echo 'supervivetd[]'.$value['id_piscina'];?>">
                                         <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'superviv[]'.$key['id_piscina'];?>">
                                        <input type="number" style = "width:100%;" class=" form-control" id="<?php echo 'supervive[]'.$value['id_piscina'];?>" name="<?php echo 'supervive[]'.$value['id_piscina'];?>" step="any"  readonly style="width:85px;" 
