...
?>
<div id="loadingb" style="display:none;position:absolute;top:512px;left:590px;z-index:9999;font-size:17px;">
 <img  src="../src/img/loader.gif" class="header-brand-img" alt="lavalite" style="z-index:9999;width:64px;"><b>&nbsp;&nbsp;&nbsp;E S P E R E . . .</b>
               </div>       

         <div class="scroll mt-5" id = "saved">
                                              <form id="mains" action="../controllers/proyeccion-alimento-fcv.php" method="post">
                                  <!-- por PISCINA, INCLUIR TOTAL SEMANAL -->  
                                     
                        <table class="table table-sm tab table-striped text-center">
                            <thead>
                                 <tr class="text-center" style="border: solid 2px #343a40"><th style="background:#333E52; border: solid 2px white; color:white;min-height:17px;margin:auto;" colspan="11"><b>PROYECCION</b></th>
                                 <th  style="background: #333E52; color:white; border: solid 2px white;margin:auto;" colspan="8"><b>ALIMENTO REAL</b></th>
                                 <th  style="background: #333E52; color:white; border: solid 2px white;margin:auto;" colspan="3"><b>PROYECTADO</b></th>
                                       <th  style="background: #333E52; color:white; border: solid 2px white;margin:auto;" colspan="6"><b> SEMANA ANTERIOR</b></th>
                                 </tr>
                                <tr class="text-center" style="border: solid 2px #343a40">

                                    <th style="background: #404E67; border: solid 2px #343a40; color:white;min-height:17px;">Ps</th>

                                    <th style="background: #404E67; border: solid 2px #343a40; color:white;min-height:17px;">Ha</th>
                                    
                                    <th style="background: #404E67; border: solid 2px #343a40; color:white;min-height:17px;">Días</th>
                                    
                                            <th style="background: #404E67; border: solid 2px #343a40; color:white;min-height:17px;"># Anim.<br>sembra.</th>
                                    
                                    <th style="background: #404E67; border: solid 2px #343a40; color:white;min-height:17px;"># Anim. <br>proyect.</th>
                                    
                                        <th style="background: #404E67; border: solid 2px #343a40; color:white;min-height:17px;">% Sob.</th>
                                     
                                    <th style="background: #404E67; border: solid 2px #343a40; color:white;min-height:17px;">Peso<br>act. </th>
                                    
                                 <th style="background: #404E67; border: solid 2px #343a40; color:white;min-height:17px;">Increm. </th>
                                    
                                     <th style="background: #404E67; border: solid 2px #343a40; color:white;min-height:17px;">Peso<br>Proy.</th>
                                             <th style="background: #404E67; border: solid 2px #343a40; color:white;min-height:17px;">  Increm <br>mie.</th>
                                      <th style="background: #404E67; border: solid 2px #343a40; color:white;min-height:17px;">BW</th>
                                    ...
                                    <th style="background: #404E67; color:white; border: solid 2px #343a40;">Dom<br>
                                        ...
                                        <th style="background: #404E67; color:white; border: solid 2px #343a40;">
                                        Alim. </br> real</th>
                                             <th style="background: #c35465; color:white; border: solid 2px #343a40;" colspan="1">
                                       <b>Alim.<br> Suger.</b> </th>
                                  <th style="background: #c35465; color:white; border: solid 2px #343a40;" colspan="1">
                                        <b>% Alim.<br>Ejec.</b></th>
                                 <th style="background: #c35465; color:white; border: solid 2px #343a40;" colspan="1">
                                        <b>Fcv <br>Proyect.</b></th>

                            <th style="background: #404e67; color:white; border: solid 2px #343a40;width:4%; ">
                                        Alim. <br>ant</th>
                                     ...
                                     <th style="background: #404e67; color:white; border: solid 2px #343a40;">
                                        Alim. </br> sug. ant.</th>
                                 <th style="background: #404e67; color:white; border: solid 2px #343a40;">
                                        # Anim. <br>proyect. ant.</th>
                                     <th style="background: #404e67; color:white; border: solid 2px #343a40;">
                                        Power bi <br>proyect. act.</th>
                                  <th style="background: #404e67; color:white; border: solid 2px #343a40;">
                                        Power bi <br> Fcv. ant.</th>
                            ...
                            <tbody class="text-center">
                             ...
                             $datosatomicos = $conectar->mostrar($sql); 
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <!-- numero de piscina -->
                                        <td class="align-middle text-center" data-toggle="modal" data-target=".bd-example-modal-sm<?php echo $psm; ?>" style="padding:1px;border: 1px solid #40497C; background:none;" alt="<?php echo 'piscinas[]'.$value['id_piscina'];?>">
                                            <span class="text-secondary text-xs font-weight-bold" class=" form-control" id="<?php echo 'piscinas[]'.$value['id_piscina'];?>" name="<?php echo 'piscinas[]'.$value['id_piscina'];?>">
                                                <?php
                                                    ...
                                                    }else if($value['id_piscina'] == 22 AND $camaronera == 2){
                                                      //  echo '17B';
                                                        $aux = 22;
                                                    }else if($value['id_piscina'] == 23 AND $camaronera == 2){
                                                      //  echo '17B';
                                                        $aux = 23;
                                                    }else if($value['id_piscina'] == 24 AND $camaronera == 2){
                                                      //  echo '17B';
                                                        $aux = 24;
                                                    }else{
                                                     $aux = $value['id_piscina'];
                                                ...
                                                <input type="text" class="input2 form-control"  id = "<?php echo 'piscinas[]'.$value['id_piscina']; ?>"  name="<?php echo 'piscinas[]'.$value['id_piscina']; ?>" readonly value="<?php  if($value['id_piscina'] == 22 AND $camaronera == 2)
                                                    { echo '17B'; 
                                                    } else if ($value['id_piscina'] == 23 AND $camaronera == 2) {
                                                        echo '15A'; 
                                                    } else if ($value['id_piscina'] == 24 AND $camaronera == 2) {
                                                    ...
                                                    { echo $value['id_piscina'];} ?>" readonly style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center; background:none;">
                                        ...
                                        <!-- hectareas de picina --> 
                                        <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C; background:none;" class="input2 form-control"  id = "<?php echo 'hastd[]'.$value['id_piscina']; ?>"  name="<?php echo 'hastd[]'.$value['id_piscina']; ?>">
                                            <span class="text-secondary text-xs font-weight-bold">
                                                <?php $ha = $value['hectareas']; ?>
                                             <input type="text" class="input2 form-control"  id = "<?php echo 'has[]'.$value['id_piscina']; ?>"  name="<?php echo 'has[]'.$value['id_piscina']; ?>" readonly value="<?php echo  $value['hectareas']; ?>" readonly style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center; background:none;">
                                            </span>
                                        </td>
                                        ...
                                        <!-- dias transcurridos -->
                                        <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C; background:none;">
                                            <?php
                                        ...
                                        <!-- animales sembrados -->
                                        <td class="align-middle text-center" style="padding:3px;border: 1px solid #40497C; background:none;">
                                            <?php
                                            ...
                                            ?>
                                                ...
                                                <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center; background:none; width:80px;" class=" form-control" id="<?php echo 'densidadess[]'.$value['id_piscina'];?>" name="<?php echo 'densidadess[]'.$value['id_piscina'];?>" step="any" readonly placeholder="0.00" style="" value ="<?php  if ($densidads == 0 || $densidads == null) {
                                                                                                        echo $densidads = 0;
                                                                                                    } else {
                                        ...
                                        <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;">
                                            ...
                                            <?php    $densalterna = intval($densidads - ($mor_diaria*$currentday)); ?>
                                            ...
                                            ?>
                                                <?php   $densalterna = intval($proyecto*10000);   ?>
                                                                                    <?php   
                                            } 
                                            
                                            ?>
                                                <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'cantidad[]'.$key['id_piscina'];?>">
                                              <?php if ($datosatomicos[0]['densidad'] >1){   ?>
                                                    <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;color:blue; background:none; width:80px;" class=" form-control" id="<?php echo 'densidades[]'.$value['id_piscina'];?>" name="<?php echo 'densidades[]'.$value['id_piscina'];?>" step="any" readonly  placeholder="0.00" style="" value ="<?php  echo $datosatomicos[0]['densidad']; $densref = $datosatomicos[0]['densidad']; ?>">     
                                             <?php  }else { ?>
                                                    <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center; background:none; width:80px;" class=" form-control" id="<?php echo 'densidades[]'.$value['id_piscina'];?>" name="<?php echo 'densidades[]'.$value['id_piscina'];?>" step="any" readonly  placeholder="0.00" style="" value ="<?php  echo $densalterna; $densref = $densalterna; ?>"> 
                                              <?php } ?>
                                              ...
                                              <?php if ($datosatomicos[0]['supervivencia'] > 0){ ?>
                                        <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C; background:none;">
                                            <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'superviv[]'.$key['id_piscina'];?>">
                                            <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center; background:none; width:70px;" class=" form-control" id="<?php echo 'supervive[]'.$value['id_piscina'];?>" name="<?php echo 'supervive[]'.$value['id_piscina'];?>" step="any"  readonly style="" 
                                                value ="<?php   echo $datosatomicos[0]['supervivencia']; ?>"> </span>
                                        </td>
                                        <?php } else { ?>

                                        <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C; background:none;" id="<?php echo 'supervivetd[]'.$value['id_piscina'];?>">
                                         <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'superviv[]'.$key['id_piscina'];?>">
                                        <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center; background:none; width:70px;" class=" form-control" id="<?php echo 'supervive[]'.$value['id_piscina'];?>" name="<?php echo 'supervive[]'.$value['id_piscina'];?>" step="any"  readonly style="" 
                             ...
                             <input type="text" class="input2 form-control"  id = "<?php echo 'peso[]'.$value['id_piscina']; ?>"  name="<?php echo 'peso[]'.$value['id_piscina']; ?>" readonly value="<?php echo $peso1; ?>" readonly style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center; background:none;">
                                         
                                                                                                    </span>
                                        </td>
 
                                        <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C; background:none;">
                                            <span class="text-warning text-xs font-weight-bold" id="<?php echo 'cantidad[]'.$key['id_piscina'];?>">
                                                 <?echo $datosatomicos[0]['crecimiento']; ?>
                                            </span>
                                        </td>
                                        
                                           <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C; background:none;" id="<?php echo 'pesofinalestd[]'.$value['id_piscina'];?>" >
                                   ...
                                   <?echo $datosatomicos[0]['peso_proyectado']; ?>
                                           ...
                                           // $sql = "SELECT peso FROM registro_peso WHERE fecha_peso > '$desde_ante' and fecha_peso < '$hasta_ante' AND id_piscina = '$aux' AND id_camaronera = '$camaronera' AND id_corrida = '$aux_corrida' ORDER BY fecha_peso DESC LIMIT 1;";
                                            ...
                                            <span class="text-secondary text-xs font-weight-bold">
                                                ...
                                                ?>
                         <input type="text" class="input2 form-control"  id = "<?php echo 'intermedio[]'.$value['id_piscina']; ?>"  name="<?php echo 'intermedio[]'.$value['id_piscina']; ?>" readonly value="<?php echo $r2; ?>" readonly style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center; background:none;">
                                
                                            </span>
                                            <?php ?>
                                        </td>
                                         
<!-- AQUI MUESTRA LA PRIMERA PARTE DEL BW -->                         
                                      ...
                                      <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C; background:none;" id = "<?php echo 'factorestd[]'.$value['id_piscina']; ?>">
...
<!-- cantidad dia lunes -->
                                        ...
                                        ?>
                                        <td class="align-middle text-center" title="<?php echo $td . ' ' . $tg; if($observacion != 'S/N'){ echo ' / '.$observacion; } ?>" style="padding:1px;border: 1px solid #40497C; background:none;">
                                            <?php
                                  ...
                                  <?echo $datosatomicos[0]['sab']; ?>
                                        ...
                                        <!-- cantidad dia domingo    
                                           <td class="align-middle text-center" style="border: 1px solid #40497C;width:5%" id="<?php echo 'alimentotd7[]'.$value['id_piscina'];?>" >
                                            ...
                                            <span class="text-secondary text-xs font-weight-bold">
                               <?php echo $datosatomicos[0]['dom']; ?>
                                            </span>

                                         </td>-->
                                         

                                        <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;width:5%; background:none;">
                                            <?php
...
<!-- AQUI SON LOS KILOS PROYECTADOS  -->
                                        <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;" id="<?php echo 'alimentotd0[]'.$value['id_piscina'];?>" >

                                            <span class="text-secondary text-xs font-weight-bold">
                                                    <?php echo  $semanatotal = $datosatomicos[0]['alimento_proyectado']; ?>
                                            </span>

                                         </td>
                                        
                                     <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C; background:none;" id="<?php echo 'porcentajetd[]'.$value['id_piscina'];?>" >
                                        ...
                                        ?>
                                                                             ...
                                                                             <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C; background:none;" id="<?php echo 'fcvtd[]'.$value['id_piscina'];?>" >

                                            <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'fcvt[]'.$key['id_piscina'];?>">
                                 <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;color:blue; background:none;" class=" form-control" id="<?php echo 'fcv[]'.$value['id_piscina'];?>" name="<?php echo 'fcv[]'.$value['id_piscina'];?>" value="<?php echo $datosatomicos[0]['fcv_proyectado'];?>" step="any"  readonly  placeholder="" style="" onfocus="myFunction(this)">
...
";
                                        ...
                                        ?>
                                            ...
                                            if ($peso1 < 2.00) {
                                                ...
                                                echo  ' <span class="text-warning text-xs font-weight-bold">' . abs($peso1) . '</span>';
                                            }
                                            ?>
                                                
                                        </td>
                                        
                                                                                                                        <td class="align-middle text-center" style="padding:1px;margin:0px;border: 1px solid #40497C; background:none;" id="<?php echo 'fcv_proyecttd[]'.$value['id_piscina'];?>" name="<?php echo 'fcv_proyecttd[]'.$value['id_piscina'];?>">
                                            <?php
                                            $sql_histo = "SELECT densidad, alimento_proyectado FROM proyeccion_alimento_test WHERE camaronera = '$camaronera' AND ps = '$aux' AND fecha >= '$desde_ante' AND fecha <= '$hasta_ante';";
                                    ...
                                    <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'fcv_fijo[]'.$key['id_piscina'];?>">
                                            <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center; background:none;" class=" form-control" id="<?php echo 'fcv_proyect[]'.$value['id_piscina'];?>" name="<?php echo 'fcv_proyect[]'.$value['id_piscina'];?>" step="any" readonly style="" 
                                    ...
                                    <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'fcv_fijo[]'.$key['id_piscina'];?>">
                                        ...
                                        ?>
                                                ...
                                                <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center; background:none;" class=" form-control" id="<?php echo 'densidadesfijo[]'.$value['id_piscina'];?>" name="<?php echo 'densidadesfijo[]'.$value['id_piscina'];?>" step="any" readonly placeholder="0.00" style="" 
                                        ...
                                        ?>
                                                <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'cantidadfijo[]'.$key['id_piscina'];?>">
                                                <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center; background:none;" class=" form-control" id="<?php echo 'densidadesfijo[]'.$value['id_piscina'];?>" name="<?php echo 'densidadesfijo[]'.$value['id_piscina'];?>" step="any" readonly placeholder="0.00" style="" value ="<?php  if ($densidad == 0 || $densidad == null) {
                                                                                                        echo $densidad = 0;
                                                                                                    } else {
                                        ...
                                        ?>
                                                                                ...
                                                                                <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C; background:none;" id="<?php echo 'fcv_proyecttd[]'.$value['id_piscina'];?>" name="<?php echo 'fcv_proyecttd[]'.$value['id_piscina'];?>">
                                            <?php
                                        ...
                                        //    }
                                            ?>
                                    <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'fcv_fijo[]'.$key['id_piscina'];?>">
                                            <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;color:blue; background:none;" class=" form-control" id="<?php echo 'fcv_proyect[]'.$value['id_piscina'];?>" name="<?php echo 'fcv_proyect[]'.$value['id_piscina'];?>" step="any" readonly 
                 ...
                 $factorTotal = + ($a1/$datosatomicos[0]['ha']*1000)/($datosatomicos[0]['lun'] * $datosatomicos[0]['bw1']) 
                            ...
                            + ($a7/$datosatomicos[0]['ha']*1000)/($datosatomicos[0]['dom'] * $datosatomicos[0]['bw7']);
                                //  echo $factorTotal ;
                                 ...
                                 <td class="align-middle text-center" style="padding:1px;border: solid 2px #343a40; color:white; background:none;"  colspan="18">
                                     ...
                                     OR $_SESSION['id']==21 OR $_SESSION['id']==12 OR $_SESSION['id']==17 OR $_SESSION['id']==90 OR $_SESSION['id']==92
                                     ){?>
                                          <tr style=" border: solid 0px #343a40; color:white;">
                                 <td class="align-middle text-center" style="padding:1px;border: solid 0px #343a40; color:white; background:none;"  colspan="28">
                         ...
                         <img id="loadingb" src="../src/img/loader.gif" class="header-brand-img" alt="lavalite" style="display:none; position:absolute;top:512px;right:600px;z-index:9999;width:64px; background:none;">
                       </form>
                    </div>
...
{ echo $value['id_piscina'];} ?>" readonly style="background:none;border:0">
                                                <input type="hidden" name="corridas[]" value="<?php echo $value['id_corrida']; ?>">
                                        ...
                                        <!-- hectareas de picina -->
                                        <td class="align-middle text-center" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;" class="input2 form-control"  id = "<?php echo 'hastd[]'.$value['id_piscina']; ?>"  name="<?php echo 'hastd[]'.$value['id_piscina']; ?>">
                                            <span class="text-secondary text-xs font-weight-bold">
                                                <?php $ha = $value['hectareas']; ?>
                                     <input type="text" class="input2 form-control"  id = "<?php echo 'has[]'.$value['id_piscina']; ?>"  name="<?php echo 'has[]'.$value['id_piscina']; ?>" readonly value="<?php echo  $value['hectareas']; ?>" readonly style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;">
                                            </span>
                                        </td>
                             ...
                             <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;">
                                            ...
                                            ?>
                                                <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'cantidads[]'.$key['id_piscina'];?>">
                                                <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center; width:80px;" class=" form-control" id="<?php echo 'densidadess[]'.$value['id_piscina'];?>" name="<?php echo 'densidadess[]'.$value['id_piscina'];?>" step="any" readonly placeholder="0.00" style="" value ="<?php  if ($densidads == 0 || $densidads == null) {
                                                                                                        echo $densidads = 0;
                                                                                                    } else {
                                                                                                        echo  intval($densidads);
                                                                                                    } ?>">
                                        ...
                                        ?>
                                                                                        ...
                                                                                        <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'cantidad[]'.$key['id_piscina'];?>">
                                                <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;color:red; width:80px;" class=" form-control" id="<?php echo 'densidades[]'.$value['id_piscina'];?>" name="<?php echo 'densidades[]'.$value['id_piscina'];?>" step="any"  placeholder="0.00" style="" 
                                        ...
                                        ?>
                                                <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'cantidad[]'.$key['id_piscina'];?>">
                                                <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;color:green;" class=" form-control" id="<?php echo 'densidades[]'.$value['id_piscina'];?>" name="<?php echo 'densidades[]'.$value['id_piscina'];?>" step="any"  placeholder="0.00" style="" value ="<?php   
                                        ...
                                        ?>
                                         ...
                                         <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'superviv[]'.$key['id_piscina'];?>">
                                        <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center; width: 70px;" class=" form-control" id="<?php echo 'supervive[]'.$value['id_piscina'];?>" name="<?php echo 'supervive[]'.$value['id_piscina'];?>" step="any"  readonly style="" 
                                                value ="<?php echo number_format(floatval($densref / $densidads)*100, 2, '.', ''); ?>">
                                            </span>
                             ...
                             <input type="text" class="input2 form-control"  id = "<?php echo 'peso[]'.$value['id_piscina']; ?>"  name="<?php echo 'peso[]'.$value['id_piscina']; ?>" readonly value="<?php echo $peso1; ?>" readonly style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;">
                                        ...
                                        <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;">
                                            <span class="text-warning text-xs font-weight-bold" id="<?php echo 'cantidad[]'.$key['id_piscina'];?>">
                                                <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'crecimientos[]'.$value['id_piscina'];?>" name="<?php echo 'crecimientos[]'.$value['id_piscina'];?>" value ="<?echo $datosatomicos[0]['crecimiento']; ?>" step="any"  placeholder="0.00" style="">
                                            </span>
                                        </td>
                                           ...
                                           <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C" id="<?php echo 'pesofinalestd[]'.$value['id_piscina'];?>" >
                                            ...
                                            <span class="text-secondary text-xs font-weight-bold">
                                 <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'pesofinales[]'.$value['id_piscina'];?>" name="<?php echo 'pesofinales[]'.$value['id_piscina'];?>" value ="<?echo $datosatomicos[0]['peso_proyectado']; ?>" step="any"  readonly placeholder="" style="" onfocus="myFunction(this)">
                                        ...
                                        <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C">
                                           ...
                                           // $sql = "SELECT peso FROM registro_peso WHERE fecha_peso > '$desde_ante' and fecha_peso < '$hasta_ante' AND id_piscina = '$aux' AND id_camaronera = '$camaronera' AND id_corrida = '$aux_corrida' ORDER BY fecha_peso DESC LIMIT 1;";
                                            ...
                                            <span class="text-secondary text-xs font-weight-bold">
                                                ...
                                                ?>
                         <input type="text" class="input2 form-control"  id = "<?php echo 'intermedio[]'.$value['id_piscina']; ?>"  name="<?php echo 'intermedio[]'.$value['id_piscina']; ?>" readonly value="<?php echo $r2; ?>" readonly style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;">
  ...
  <!-- cantidad dia lunes -->
                                ...
                                <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C">
                                     ...
                                     <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;" id="<?php echo 'alimentotd0[]'.$value['id_piscina'];?>" >
                                            ...
                                            <span class="text-secondary text-xs font-weight-bold">
                                 <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'alimento0[]'.$value['id_piscina'];?>" name="<?php echo 'alimento0[]'.$value['id_piscina'];?>" step="any"  readonly placeholder="" style="" onfocus="myFunction(this)">
                                     ...
                                     <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;" id="<?php echo 'porcentajetd[]'.$value['id_piscina'];?>" >
                                            ...
                                            <span class="text-secondary text-xs font-weight-bold">
                                 <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'porcentaje[]'.$value['id_piscina'];?>" name="<?php echo 'porcentaje[]'.$value['id_piscina'];?>" value="0.00" step="any"  readonly  placeholder="" style="" onfocus="myFunction(this)">
                                            ...
                                            <span class="text-secondary text-xs font-weight-bold">
                                 <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;color:blue;" class=" form-control" id="<?php echo 'fcv[]'.$value['id_piscina'];?>" name="<?php echo 'fcv[]'.$value['id_piscina'];?>" value="0.00" step="any"  readonly  placeholder="" style="" onfocus="myFunction(this)">
...
";
                                        ...
                                        ?>
                                                                                        ...
                                                                                        <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'cantidadfijo[]'.$key['id_piscina'];?>">
                                                <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'densidadesfijo[]'.$value['id_piscina'];?>" name="<?php echo 'densidadesfijo[]'.$value['id_piscina'];?>" step="any" readonly placeholder="0.00" style="" 
                                                value ="<?php       echo $densref =  $densidads - ($mor_diaria*$currentday); ?>">
                                            </span>
                                        ...
                                        ?>
                                                <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'cantidadfijo[]'.$key['id_piscina'];?>">
                                                <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'densidadesfijo[]'.$value['id_piscina'];?>" name="<?php echo 'densidadesfijo[]'.$value['id_piscina'];?>" step="any" readonly placeholder="0.00" style="" value ="<?php  if ($densidad == 0 || $densidad == null) {
                                                                                                        echo $densidad = 0;
                                                                                                    } else {
                                                                                               echo  $densref = intval($proyecto*10000);         // echo  $densref = intval($densidad);
                                                                                                    } ?>">
                                        ...
                                        //    }
                                            ?>
                                    <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'fcv_fijo[]'.$key['id_piscina'];?>">
                                            <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;color:blue;" class=" form-control" id="<?php echo 'fcv_proyect[]'.$value['id_piscina'];?>" name="<?php echo 'fcv_proyect[]'.$value['id_piscina'];?>" step="any" readonly style="" 
                                                value ="<?php echo number_format($fcv, 2) ;  ?>"> 
                                    </span> </td>
                 ...
                 $factorTotal = + ($a1/$datosatomicos[0]['ha']*1000)/($datosatomicos[0]['lun'] * $datosatomicos[0]['bw1']) 
                            ...
                            <img id="loadingc" src="../src/img/loader.gif" class="header-brand-img" alt="lavalite" style="display:none; position:absolute;top:512px;right:600px;z-index:9999;width:64px;">
                    </div>
...
{ echo $value['id_piscina'];} ?>" readonly style="background:none;border:0">
                                        ...
                                        <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;" class="input2 form-control"  id = "<?php echo 'hastd[]'.$value['id_piscina']; ?>"  name="<?php echo 'hastd[]'.$value['id_piscina']; ?>">
                                            <span class="text-secondary text-xs font-weight-bold">
                                                <?php $ha = $value['hectareas']; ?>
                                     <input type="text" class="input2 form-control" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;"  id = "<?php echo 'has[]'.$value['id_piscina']; ?>"  name="<?php echo 'has[]'.$value['id_piscina']; ?>" readonly value="<?php echo  $value['hectareas']; ?>" readonly style="background:none;border:0;">
                                            </span>
                                        </td>
                             ...
                             <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;">
                                        ...
                                        ?>
                                                <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'cantidad[]'.$key['id_piscina'];?>">
                                                <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;color:green;" class=" form-control" id="<?php echo 'densidades[]'.$value['id_piscina'];?>" name="<?php echo 'densidades[]'.$value['id_piscina'];?>" step="any"  placeholder="0.00" style="width:85px;" value ="<?php  if ($densidad == 0 || $densidad == null) {
                                                                                                        echo $densidad = 0;
                                                                                                    } else {
                                                                                               echo  $densref = intval($proyecto*10000);         // echo  $densref = intval($densidad);
                                                                                                    } ?>">
                             ...
                             <input type="text" class="input2 form-control" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;" id = "<?php echo 'peso[]'.$value['id_piscina']; ?>"  name="<?php echo 'peso[]'.$value['id_piscina']; ?>" readonly value="<?php echo '  '.$peso1; ?>" readonly style="background:none;border:0;">
                                        ...
                                        <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;">
                                            <span class="text-warning text-xs font-weight-bold" id="<?php echo 'cantidad[]'.$key['id_piscina'];?>">
                                                <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'crecimientos[]'.$value['id_piscina'];?>" name="<?php echo 'crecimientos[]'.$value['id_piscina'];?>" step="any"  placeholder="0.00" style="">
                                            </span>
                                        </td>
                                           ...
                                           <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C" id="<?php echo 'pesofinalestd[]'.$value['id_piscina'];?>" >
                                            ...
                                            <span class="text-secondary text-xs font-weight-bold">
                                 <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'pesofinales[]'.$value['id_piscina'];?>" name="<?php echo 'pesofinales[]'.$value['id_piscina'];?>" step="any"  readonly placeholder="" style="" onfocus="myFunction(this)">
                                        ...
                                        <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C">
                                           ...
                                           // $sql = "SELECT peso FROM registro_peso WHERE fecha_peso > '$desde_ante' and fecha_peso < '$hasta_ante' AND id_piscina = '$aux' AND id_camaronera = '$camaronera' AND id_corrida = '$aux_corrida' ORDER BY fecha_peso DESC LIMIT 1;";
                                            ...
                                            <span class="text-secondary text-xs font-weight-bold">
                                                ...
                                                ?>
                         <input type="text" class="input2 form-control" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;" id = "<?php echo 'intermedio[]'.$value['id_piscina']; ?>"  name="<?php echo 'intermedio[]'.$value['id_piscina']; ?>" readonly value="<?php echo $r2; ?>" readonly style="background:none;border:0;">
                                    ...
                                    if ($choosen < 1 ){
                                    $sqlbw="select bw from proyeccion_alimento_test WHERE camaronera = '$camaronera' AND ps = '$aux' AND fecha >= '$desde_ante' AND fecha <='$hasta_ante' AND estado = '1'";
                                    $databw = $objeto->mostrar($sqlbw);
                                    foreach ($databw as $valbw) { $choosen = $valbw['bw'];  } 
                                    } 
                                        ?>
                                    ...
                                    <select class="select"   id = "<?php echo 'factores[]'.$value['id_piscina']; ?>" name= "<?php echo 'factores[]'.$value['id_piscina']; ?>">
                                                     <option class="text-center"  id ="<?php echo 'factorese[]'.$value['id_piscina']; ?>" value="0">
                                                        [Seleccione]
                                                        </option>
                                                    <?php
  ...
  <!-- cantidad dia lunes -->
                                ...
                                <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C">
                                            ...
                                            <?php } ?>
                                              <input type="hidden" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;" name="acumulado[]" value="<?php echo intval($acum_semanal); ?>" id="<?php echo 'acumulado[]'.$value['id_piscina'];?>" >
                                        </td>
...
";
                                        ...
                                        ?>
                                            ...
                                            ?>
                                    <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'fcv_fijo[]'.$key['id_piscina'];?>">
                                            <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'fcv_proyect[]'.$value['id_piscina'];?>" name="<?php echo 'fcv_proyect[]'.$value['id_piscina'];?>" step="any" readonly style="" 
                                                value ="<?php echo $alimento_proyectado_ante ;  ?>"> 
                                    </span> </td>
                                    <td class="align-middle text-center" style="padding:1px;margin:0px;border: 1px solid #40497C;" id="<?php echo 'fcv_proyecttd[]'.$value['id_piscina'];?>" name="<?php echo 'fcv_proyecttd[]'.$value['id_piscina'];?>">
                                            <?php
                          ...
                          <?php  $fcv = "SELECT anim_min FROM simulacion_proceso_test WHERE fecha_muestreo = '$hasta_ante' AND id_camaronera = '$camaronera' and piscinas = '$aux' AND id_bio = 'BW 7 dias';";
        ...
        if (xhr.readyState === XMLHttpRequest.DONE) {
           ...
           //  alert(response.data);
            ...
            var kgha_total = kgha_lunes + kgha_martes + kgha_miercoles + kgha_jueves + kgha_viernes + kgha_sabado + kgha_domingo ;
                ...
                console.error('Erroresss: ' + xhr.status);
            }
        }
    };
