    ...
    */
    ...
    <div class="row" style="margin-left:70px;">
                ...
                <div class="card-body">
                    <div class="mb-20">
                        <form id="form-insert-run" onsubmit="return pesca()"
                                ...
                                <div class="">
                                    ...
                                    <div class="container" id="pesca" style="display:none;color:red;">
                                        ...
                                        <div class="alert alert-warning mt-3" role="alert" id="alerta2">
                                            ...
                                            <input type="hidden" name="liquidacion" class="text-white" step="any"
                                                id="liquidacion" style="border: none; background: none;" value="parcial">
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-8 col-lg-7">
                                    <div class="input-group">
                                        <select class="form-control" name="camaronera" id="camaronera">
                                            ...
                                            foreach ($data as $value) { $descripcion_camaeornea = $value['descripcion_camaronera'];
                                            ?>
                            ...
                            <div class="row">
                                <label class="col-sm-4 col-lg-5 col-form-label">Libras totales pescadas</label>
                                <div class="col-sm-8 col-lg-7">
                                    <div class="input-group">
                            ...
                            <center><button class="btn btn-danger btn-sm text-light mt-3" id="sender" style="display:none;"
                                    type="submit" onclick="fechar()">guardar datos de
                                    pesca</button></center>
                        </form>
                    </div>
                </div>
        ...
        <div class="container" style="margin-left:-15px;">
            <form class="form-inline" method="GET" action="https://aquapro.gvasco.com/views/index.php?page=Pesca">
                <input type="hidden" name="page" value="Pesca">
                <select class="form-control custom-select my-1 mr-sm-3" name="piscinas" id="piscinas">
                    <option value="">[ Seleccione piscina ]</option>
                    <?php
                        $objeto_tabla_camaronera = new corrida();
                        $sql_tabla_camaronera = "SELECT id_camaronera, piscinas, descripcion_piscina FROM piscina WHERE id_camaronera = '$camaronera'";
                        $data = $objeto_tabla_camaronera->mostrar($sql_tabla_camaronera);
                        foreach ($data as $value) {
                    ?>
                    <option value="<?php echo $value['piscinas']; ?>"
                        <?php if(isset($_GET['piscinas']) && $_GET['piscinas'] == $value['piscinas']) echo 'seleccione'; ?>>
                        <?php echo $value['descripcion_piscina']; ?>
                    </option>
                    <?php } ?>
                </select>
                <button type="submit" class="btn btn-primary" name="buscar">Buscar piscina</button>
                <a href="https://aquapro.gvasco.com/views/index.php?page=Pesca"class="btn btn-success " style="margin-left:1%;">Ver todo</a>
            </form>
        </div>
            <?php 

            if(isset($_GET['piscinas'])){
                $buscar_piscina = $_GET['piscinas'];
                ...
                $sqli = " SELECT 
                                ...
                                FROM registro_pesca_engorde x WHERE x.id_camaronera =  '$camaronera' AND id_piscina = '$buscar_piscina'
                            ...
                            FROM (
                                ...
                                WHERE x.id_camaronera = '$camaronera' AND id_piscina = '$buscar_piscina'
                                ...
                                WHERE z.id_camaronera = '$camaronera' AND id_piscina = '$buscar_piscina'
            ...
            ?>
            <table class="table table-sm table-hover table-bordered align-items-center mb-0  table-responsive"
                style="width:712px;">

                <thead>
                    <tr class="text-white text-center">
                        <th colspan="10" class="bg-dark" style="height:48px;">
                            <span class="text-white"> RALEOS Y PESCAS <?php 
                                if(isset($_GET['piscinas'])){
                                    echo $buscar_piscina = 'PISICINA: #'.$_GET['piscinas']; 
                                }else{ 
                                    echo $descripcion_camaeornea; 
                                } ?>
                            </span>
                        </th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="align-middle text-center" style="border: 1px solid #40497C;">
                            <span class="text-secondary text-xs font-weight-bold">
                                <?php  
                                    // Fecha original en formato YYYY-MM-DD
                                    $originalDate = $pesca['fecha_pesca']; 

                                    // Crear un objeto DateTime a partir de la fecha original
                                    $date = new DateTime($originalDate);

                                    // Formatear la fecha al nuevo formato DD/MMM/YY
                                    $newFormat = $date->format('d/M/y');

                                    // Convertir el nombre del mes a minúsculas
                                    $newFormat = strtolower($newFormat);

                                    // Opcional: Convertir la primera letra del mes a mayúscula
                                    $newFormat = ucfirst($newFormat);

                                    echo $newFormat; // Salida: 15/jun/24
                                ?>
                            </span>
                        </td>
                        <td class="align-middle text-center" style="border: 1px solid #40497C;">
                            <span class="text-secondary text-xs font-weight-bold"
                                id="<?php  echo 'totalkilos[]'.$descripcion_alimento; ?>">
                        ...
                        <td class="align-middle text-center" style="border: 1px solid #40497C;">
                            <span class="text-secondary text-xs font-weight-bold"
                                id="<?php  echo 'totalkilos[]'.$descripcion_alimento; ?>">
                                <?php  echo $pesca['id_corrida']; ?>
                            </span>
                        </td>
                        <td class="align-middle text-center" style="border: 1px solid #40497C;">
                            <span class="text-secondary text-xs font-weight-bold"
                                id="<?php  echo 'totalkilos[]'.$descripcion_alimento; ?>">
                                <?php  echo $pesca['hectareas']; ?>
                            </span>
                        </td>
                        <td class="align-middle text-center" style="border: 1px solid #40497C;">
                            <span class="text-secondary text-xs font-weight-bold"
                                id="<?php  echo 'totalkilos[]'.$descripcion_alimento; ?>">
                                <?php  echo intval($pesca['libras_pescadas']); ?>
                            </span>
                        </td>
                        ...
                        <td class="align-middle text-center" style="border: 1px solid #40497C;">
                            <span class="text-secondary text-xs font-weight-bold"
                                id="<?php  echo 'totalkilos[]'.$descripcion_alimento; ?>">
                                <?php  echo intval($pesca['libras_pescadas']*$pesca['hectareas']); ?>
                            </span>
                        </td>

                        <td class="align-middle text-center" style="border: 1px solid #40497C;">
                            <span class="text-secondary text-xs font-weight-bold"
                                id="<?php  echo 'solicitud[]'.$descripcion_alimento; ?>">
                        ...
                        <td class="align-middle text-center" style="border: 1px solid #40497C;">
                            <span class="text-secondary text-xs font-weight-bold"
                                id="<?php  echo 'solicitud[]'.$descripcion_alimento; ?>">
                                <?php  echo intval($pesca['rendimiento']).' %'; ?>
                            </span>
                        </td>
    ...
    <script>
        function pesca() {
            var smspre = document.getElementById("fechaActualpesca").value != "" && document.getElementById("piscina").value !=
                0;
