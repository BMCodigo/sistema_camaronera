        ...
        <div class="container" style="margin-top: -20px;">
            ...
            <table class="conatiner table table-bordered table-sm">
                <thead  style="background: #404e67;">
                    <tr>
                    <th class="text-white" scope="col"># Psiiiic</th>
...
//                               -----------------------------------------------------------
                ...
                <tbody>
                    <tr>
                    <!-- piscina -->
                    <td id="<?php echo 'piscina[]'.$val['id_balanceado']  ?>"><?php if($val['id_piscina'] == 22){ echo '17B'; }else{ echo $val['id_piscina'];} ?></td>
                    <!-- solicitado -->
                    <td class="text-dark" ><?php echo floatval($val['cantidad_balanceado']); ?></td>
                    <!-- sobrante -->
                    <td class="text-dark" id="<?php echo 'sobrante[]'.$val['id_balanceado']  ?>">
                     <?php 
                    
                        if($val['tipo_balanceado'] == 'Origin 0.5'){
                            echo floatval($val['cantidad_sobrante']);
                    ...
                    <!-- despacho -->
                    <td><input class="input-edit" type="number" style="width:100%;border:0;" id="<?php echo 'sol_cantidad[]'.$val['id_balanceado']  ?>" name="cantidad[]" value="<?php echo floatval($val['cantidad_despacho']); ?>"></td>
                    <!-- destino -->
                    <td style="color:  #0e6655 ; "><b><?php echo $val['id']; ?></b></td>
                    <!-- tipo alimento -->
                     <td><select class="form-control" name="tipo_alimento[]" id="<?php echo 'sol_tipo[]'.$val['id_balanceado']  ?>" style="width:100%;">
                ...
                <tbody>
                    ...
                    <td id="<?php echo 'sobrante[]'.$val['id_balanceado']  ?>">
                        ...
                        if($val['tipo_balanceado'] == 'Origin 0.5'){
                         ...
                         ?></td>
                    <!--<td><?php echo $val['cantidad_balanceados']; ?></td>-->
