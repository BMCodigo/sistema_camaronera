...
<div class="card">
    ...
    <div class="card-header text-center" style="background: #404e67;">
        ...
        <h6 class="container text-white" style="text-align:center">KARDEX ACTUAL</h6>
        ...
        <!--ul class="time-horizontal nav justify-content-center">
            ...
            <!--li><b><a class="nav-link text-white " href="index.php?page=Kardex-base"><i
                            class="fas fa-cogs text-danger"></i> Historico kardex hasta Abril 15 2024</a></b></li>
        </ul-->
...
<div class="container">
                    ...
                    <div class="mb-20">
                        <form action="#" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 col-lg-7">
                                    <div class="input-group">
                                        ...
                                        ?>
                                            <option
                                                value="<?php echo $value['descripcion_alimento'] . ' ' . $value['gramaje_alimento'] ?>">
                            ...
                            <div class="btn-group" role="group" aria-label="Third group">
                                <button class="btn btn-primary btn-sm text-light" type="submit">Consultar
                                    kardex</button>
                            </div>

                            <div class="btn-group" role="group" aria-label="Third group">
                                <a href="index.php?page=Kardex" class="btn btn-danger btn-sm">Saldos generales</a>
                            </div>
    ...
    <?php
        if ( isset($_POST['camaronera']) AND isset($_POST['tipo_balanceado']) AND $_POST['mode_all'] !="1" ){
              
        $sql1="SELECT * FROM `kardex` WHERE camaronera_id = '".$_POST['camaronera']."' AND tipo_balanceado = '".$_POST['tipo_balanceado']."' ORDER BY fecha ASC ";
        ...
        // $sql3 = "ORDER BY `kardex`.`fecha` ASC";
        $sql = $sql1.$sql2/*.$sql3*/;
        $data = $objeto->mostrar($sql);
    ?>
        ...
        <div class="col-12">
            <div class="table table-sm table-responsive mb-4 ">
                <table class="table table-sm table-hover table-bordered align-items-center mb-0 mt-2">
                    <div class="card"><b></b>
                        <p style="position:absolute;right:0px;" class="text-primary">Saldo a la fecha de
                            corte:&nbsp;<?php echo $data[0]['saldo']; ?></p></b>
                        <?php    
                            $sql1="SELECT * FROM `kardex` WHERE camaronera_id = '".$_POST['camaronera']."' AND tipo_balanceado = '".$_POST['tipo_balanceado']."' ORDER BY fecha ASC ";
                            if ($_POST['fechaInicial'] !=  ''){
                            $sql2 =" AND fecha >= '".$_POST['fechaInicial']."' ";  
                        ...
                        <?php
                            $sql = "SELECT * 
                                    FROM(
                                     ...
                                     --   AND e.fecha_entrega < '2024-04-14'
                                   ...
                                   --     AND i.fecha_ingreso < '2024-04-14'
                ...
                SELECT k.fecha, k.tipo_balanceado, k.saldo
                    ...
                    ?>
                      ...
                      $sql = "SELECT * FROM tipo_alimento";
                        ...
                        <b> RESUMEN GENERAL DE STOCK ACTUAL <span class="text-danger"><?php setlocale(LC_TIME, 'es_ES.UTF-8'); date_default_timezone_set('America/Guayaquil'); echo strftime('%d-%b-%Y'); ?></span> </b>
                        <table class="table table-sm table-hover table-bordered align-items-center mb-0 mt-2">
                            <thead>
                                <tr class="text-center">
                                    <th class="text-center text-white" style="background: #404e67;">Balanceado
