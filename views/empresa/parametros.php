    ...
    <div class="card">
            ...
            <li class="nav-item">
                <a href="#" onclick="venta();" class="nav-link" role="tab" aria-controls="pills-profile"
                    aria-selected="false" id="venta_sms" style="background:#900C3F;"><strong>Parametros de precio venta por libra</strong></a>
                          ...
                          <li class="nav-item">
                <a href="#" onclick="mortalidad();"  class="nav-link" role="tab" aria-controls="pills-profile" id="mortalidad_sms"
                    aria-selected="false"><strong>Mortalidad Inicial</strong></a>
            </li>
                        <li class="nav-item">
                <a href="#" onclick="biomasa();"  class="nav-link" role="tab" aria-controls="pills-profile" id="biomasa_sms"
                    aria-selected="false"><strong>Parametros BW</strong></a>
            </li>
        ...
        <div class="col-7 mt" style="margin-left:290px; margin-top: 20px; width: 530px;">
            ...
            <div class="row" style="margin:auto; margin-top: 20px; width: 500px;">
               ...
               <div class="row" style="margin:auto;display:none;" id="mortalidad">
                   <br><br>
                     <?php
                                     $_SESSION['llc']=$camaronera;
                                        if ($camaronera == 1) {

                                            echo '<h6>  <strong style="color:red;">Darsacom</strong></h6>';
                                            
                                        } else if ($camaronera == 2) {

                                      
                                            echo '<h6> <strong style="color:red;">Aquacamaron</strong></h6>';
                                            
                                        } else if ($camaronera == 3) {

                                          
                                            echo '<h6>  <strong style="color:red;">Jopisa</strong></h6>';

                                        } else if ($camaronera == 4) {

                                      
                                            echo '<h6> <strong style="color:red;">Aquanatura</strong></h6>';

                                        } else if ($camaronera == 5) {

                    
                                            echo '<h6>  <strong style="color:red;">Grupo Camaron</strong></h6>';

                                        } else if ($camaronera == 6) {

                    
                                            echo '<h6>  <strong style="color:red;">Calica</strong></h6>';
            ...
            <div class="col-4 justify-content-center">
                    <?php
                                        $objeto = new corrida();
                                        $sql_ = "SELECT ROUND(dias, 2) AS dias, ROUND(mortalidad, 2) AS mortalidad FROM parametros_soreviviencia WHERE id_camaronera = '$camaronera'";
        ...
        <form action="../controllers/modificar-mortalidad.php" method="post" style="width:450px;">
    <input type="hidden" class="form-control bg-white" name="camaronera" readonly value="<?php echo $camaronera;?>">
    <input type="hidden" name="fecha_parametro" value="<?php echo $datetime->format('Y-m-d H:i:s'); ?>">

    <div class="form-group">
        <label><strong>Mortalidad Inicial</strong></label>
        <input type="number" class="form-control" id="NumberCants" name="mortalidad"  placeholder="  <?php   echo $value['mortalidad'];?>" value="<?php echo $value['mortalidad'];?>">
    </div>

    <div class="form-group">
        <label><strong>Dias Mortalidad</strong></label>
        <input type="number" class="form-control" id="NumberCants" name="dias"  placeholder="  <?php   echo $value['dias'];?>" value="<?php echo $value['dias'];?>">
    </div>
 <br><br>
    <center>
            ...
            <div class="col-4 justify-content-center">
                <ul class="list-group list-group-flush text-uppecasse text-center"
                    ...
                    <!--li class=" text-uppercase"><strong>camaronera
                                <?php if($camaronera == 1){ echo "Darsacom";}else if($camaronera == 2){ echo "Aquacamaron";}else if($camaronera == 3){ echo "Jopisa";}else if($camaronera == 4){ echo "Aquanatura";}else if($camaronera == 5){ echo "Grupo Camaron";}else if($camaronera == 6){ echo "Calica";}; ?></strong>
                        </li-->
                </ul>
                <br>
                <form action="../controllers/insert-parametros-piscina.php" method="post" style="width:450px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control bg-white" name="camaronera" readonly
                            value="<?php if($camaronera == 1){ echo "Darsacom";}else if($camaronera == 2){ echo "Aquacamaron";}else if($camaronera == 3){ echo "Jopisa";}else if($camaronera == 4){ echo "Aquanatura";}else if($camaronera == 5){ echo "Grupo Camaron";}else if($camaronera == 6){ echo "Calica";}; ?>">
...
elemento.style.display = "none";
      ...
      var elemento6 = document.getElementById("mortalidad");
...
function solicitud() {
    ...
    var elemento = document.getElementById("ventas");
    elemento.style.display = "none";
    var mortalidad_sms = document.getElementById("mortalidad_sms");
    mortalidad_sms.style.background = "white";
    var mortalidad_sms = document.getElementById("mortalidad_sms");
    mortalidad_sms.style.color = "black";
...
function mortalidad() {
    ...
    var elemento5 = document.getElementById("mensaje");
    elemento5.style.display = "none";
        var elemento6 = document.getElementById("ventas");
    elemento6.style.display = "none";
    var mortalidad_sms = document.getElementById("mortalidad_sms");
    mortalidad_sms.style.background = "#900C3F";
    mortalidad_sms.style.color = "white";
     var solicitud_sms = document.getElementById("solicitud_sms");
    solicitud_sms.style.background = "white";
    var solicitud_sms = document.getElementById("solicitud_sms");
    solicitud_sms.style.color = "black";
    ...
    venta_sms.style.color = "black";
    var biomasa_sms = document.getElementById("biomasa_sms");
    biomasa_sms.style.background = "white";
    var biomasa_sms = document.getElementById("biomasa_sms");
    biomasa_sms.style.color = "black";
        var elemento = document.getElementById("mortalidad");
    elemento.style.display = "block";
}
</script>