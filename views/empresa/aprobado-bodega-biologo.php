...
<div class="card">
    <div class="card-header" style="background: #404e67;">
        <h6 class="text-white" style="margin:auto;"><?php $page;
                                                    if ($page == 'Aprobado-bodega-biologo') {
                                                        echo 'SOLICITUDES DE BALANCEADO APROBADAS';
                                                    } ?></h6>
        <ul class="time-horizontal nav justify-content-center">
            ...
            <li>
                <div class="dropdown mt-2">
                    <a class="dropdown-toggle text-white" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-check-square text-success"></i>
                        <b> Solicitud generadas</b>
                    </a>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        
                        <a class="dropdown-item" href="index.php?page=Aprobacion-solicitud"> <i class="fas fa-check-square text-danger"> </i> Por aprobrar </a>
            ...
            <div class="card-body">
                <div class="scroll">
                    ...
                    <table id="data_table" class="table table-sm table-bordered">
                        ...
                        $sql_soli = "SELECT DISTINCT id_secuencia FROM solicitud_balanceados WHERE camaronera = '$camaronera' ORDER BY id_secuencia DESC  LIMIT  20";
                        $data_soli = $objeto->mostrar($sql_soli);
                        foreach ($data_soli as $val) {
                            $solicitud = $val['id_secuencia'];

                            $sql = "SELECT * FROM solicitud_balanceados WHERE camaronera = '$camaronera' AND id_secuencia = '$solicitud' AND id_secuencia > 0 AND estado = 'Aprobado' ORDER BY id_secuencia LIMIT 1";
