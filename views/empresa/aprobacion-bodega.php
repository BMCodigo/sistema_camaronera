...
<div class="card">
    <div class="card-header" style="background: #404e67;">
        <h6 class="text-white" style="margin:auto;"><?php $page; if($page == 'Aprobacion-solicitud'){ echo 'SOLICITUDES DE DESPACHO POR APROBAR'; } ?></h6>
             ...
             <!--     <li><b><a class="nav-link text-white " href="index.php?page=Ingreso"><i class="fas fa-copy text-info"></i>
                ...
                <div class="dropdown mt-2">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <a class="dropdown-item" href="index.php?page=Aprobado-bodega-biologo"> <i class="fas fa-check-circle text-success"> </i> Aprobadas </a>
            ...
            <a href="javascript:location.reload()" class="btn btn-secondary mb-5 float-right">Actualizar pagina</a><br>
                ...
                <table id="data_table" class="table table-sm table-bordered mt-5">
                    ...
                    <?php
                            ...
                            $sql = "SELECT * FROM solicitud_balanceados WHERE camaronera = '$camaronera' AND estado = 'En proceso' AND fecha_entrega = curdate() ORDER BY id_secuencia LIMIT 1";
