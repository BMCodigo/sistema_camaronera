        ...
        <div class="container" style="margin-top: -20px;">
            ...
            <table class="conatiner table table-bordered table-sm">
                <thead  style="background: #404e67;">
                    ...
                    <th class="text-white" scope="col">Cant. <br> Sobrante (kg) </th>
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM solicitud_balanceados WHERE camaronera = '$camaronera' AND id_secuencia = '$id' AND id = 'Piscina' AND estado = 'Aprobado'";
                ...
                <tbody>
                    ...
                    <td><?php echo intval($val['cantidad_despacho']); ?></td>
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM solicitud_balanceados WHERE camaronera = '$camaronera' AND id_secuencia = '$id' AND id = 'Precria' AND estado = 'Aprobado'";
                    $data = $objeto->mostrar($sql);
                    foreach ($data as $val) {
