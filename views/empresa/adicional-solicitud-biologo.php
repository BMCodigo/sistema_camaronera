        ...
        if (xhr.readyState === XMLHttpRequest.DONE) {
            if (xhr.status === 200) {
                ...
                var tipo_kilo = response.kilo;
                 //   floater(despachos);
               //  alert(cantidades); alert(sobrantes);alert(despachos);*********************************
    ...
    <div class="row mt-5 mr-2">
        ...
        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mt-3">
            <div class="table table-sm table-responsive">
                <div class="scroll">
                    <form id="main" class="container" action="../controllers/insert-alcance-solicitud.php" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center" style="border: 1px solid #40497C">
                                            ...
                                            <?php } ?>
                                                ...
                                                <input type="text" class="input2 form-control"  id = "<?php echo 'piscinas[]'.$key['id_piscina']; ?>"  name="piscina[]" value="<?php  if($key['id_piscina'] == 22  OR $key['id_piscina'] == 24 ){  if($key['id_piscina'] == 22 ){ echo '17B';}else{ echo '15B'; } }else{ echo $key['id_piscina'];} ?>" readonly style="background:none;">
                                               ...
                                               AND estado = 'En Proceso'
                                                     ORDER BY `solicitud_balanceados`.`fecha_entrega` DESC;";
                                                          ...
                                                          if (intval($aprobados[0]['registros']) > 0 ) { ?>
                                                               <b style ="color:red"> Ya no esta permitido realizar mas solicitudes de ENGORDE para el dia de hoy</b>
        ...
        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 mt-3">
            <div class="table table-sm table-responsive">
                <div class="scroll">
                    <form class="container" action="../controllers/insert-alcance-precria.php" method="post">
                        <table class="table table-sm table-bordered align-items-center mb-0">
                                               ...
                                               AND descripcion = 'Consumo precria'
                                                AND estado = 'En Proceso'
                                                     ORDER BY `solicitud_balanceados`.`fecha_entrega` DESC;";
                                                          ...
                                                          $aprobados = $objeto->mostrar($sql); 
                                                          if (intval($aprobados[0]['registros']) > 0 ) { ?>
                                                               <b style ="color:red"> Ya no esta permitido realizar mas solicitudes de PRECRIA para el dia de hoy</b>
