    ...
    $mondayDate = $monday->format('Y-m-d');
        echo '<b>Semana #'.$weekNumber.'';
         ?>
          ...
          <div style = "color:#f6f7fb;" id = "getantes" name = "getantes"><?php echo $hasta_ante;  ?></div><h1><b style="color:red;">T E S T</b></h1>
         <?php
    if (count($datar)>=1){
                       ...
                       <table class="table table-sm tab table-striped">
                            <thead>
                                 ...
                                 <th  style="background: white; color:black; border: solid 2px #343a40;margin:auto;" colspan="3"><b>PROYECTADO</b></th>
                                       <th  style="background: white; color:black; border: solid 2px #343a40;margin:auto;" colspan="6"><b>REFERENCIAS</b></th>
                                 </tr>
...
";
                                    ...
                                    <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'fcv_fijo[]'.$key['id_piscina'];?>">
                                        ...
                                        ?>
                                                ...
                                                <input type="number" style = "padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'densidadesfijo[]'.$value['id_piscina'];?>" name="<?php echo 'densidadesfijo[]'.$value['id_piscina'];?>" step="any" readonly placeholder="0.00" style="width:85px;" 
                                                value ="<?php       echo $densref =  intval($densidads - ($mor_diaria*$currentday)); ?>">
                                            </span>
                                        ...
                                        ?>
                                                <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'cantidadfijo[]'.$key['id_piscina'];?>">
                                                <input type="number"  style = "padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'densidadesfijo[]'.$value['id_piscina'];?>" name="<?php echo 'densidadesfijo[]'.$value['id_piscina'];?>" step="any" readonly placeholder="0.00" style="width:85px;" value ="<?php  if ($densidad == 0 || $densidad == null) {
                                                                                                        echo $densidad = 0;
                                                                                                    } else {
                                        ...
                                        ?>
                                                                                ...
                                                                                <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;width:22%;" id="<?php echo 'fcv_proyecttd[]'.$value['id_piscina'];?>" name="<?php echo 'fcv_proyecttd[]'.$value['id_piscina'];?>">
                                            <?php
                                        ...
                                        //    }
                                            ?>
                                    <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'fcv_fijo[]'.$key['id_piscina'];?>">
                                            <input type="number" style = "padding:0px;margin:0px;border:0px;text-align:center;color:blue;" class=" form-control" id="<?php echo 'fcv_proyect[]'.$value['id_piscina'];?>" name="<?php echo 'fcv_proyect[]'.$value['id_piscina'];?>" step="any" readonly style="width:85px;" 
