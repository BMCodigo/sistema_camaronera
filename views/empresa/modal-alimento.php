            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-justify text-left" style="margin-top: -12px;">
                    ...
                    <?php
                        ...
                        $sql = "SELECT fecha_alimentacion, id_tipo_alimento, cantidad, id_tipo_alimento_2, cantidad_2 FROM registro_alimentacion_engorde WHERE id_piscina = '$ps' AND id_camaronera = '$camaronera' AND id_corrida = '$c' AND fecha_alimentacion BETWEEN '$desde' AND '$fechaActual' ORDER BY fecha_alimentacion";
