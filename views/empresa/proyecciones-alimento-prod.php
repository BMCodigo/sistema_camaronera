...
?>
         ...
         <div class="scroll mt-5">
                        ...
                        <table class="table table-sm tab table-striped">
                            <thead>
                                 <tr class="text-center" style="border: solid 2px #343a40"><th style="background:orange; border: solid 2px #343a40; color:black;min-height:17px;margin:auto;" colspan="9"><b>PROYECCION</b></th>
...
";
                                        ...
                                        <td class="align-middle text-center" style="border: 1px solid #40497C">
                                            <span class="text-secondary text-xs font-weight-bold"><?php if ($peso11 == 0 || $peso11 == null || $acum_semanal == 0) {
                                                                                                     $peso11 = 0.00;
                                                                                                    } else {
                                                                                                        // $peso11;
                                                                                                    } ?></span>
                   <input type="text" class="input2 form-control"  id = "<?php echo 'alproyectado[]'.$value['id_piscina']; ?>"  name="<?php echo 'alproyectado[]'.$value['id_piscina']; ?>" readonly value="<?php echo $peso11; ?>" readonly style="background:none;border:0;width:100%;">
...
?>
   ...
   <th style="background: #404e67; color:white; border: solid 2px #343a40;">
                            ...
                            <tbody>
                             ...
                             <td class="align-middle text-center" style="border: 1px solid #40497C;width:9%;">
                                            <?php
