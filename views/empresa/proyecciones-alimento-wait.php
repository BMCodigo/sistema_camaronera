                            ...
                            <thead>
                                ...
                                <tr class="text-center" style="border: solid 2px #343a40">
                                    ...
                                    <th style="background: #555557; border: solid 2px #343a40; color:white;min-height:17px;">Días</th>
                                            ...
                                            <th style="background: #555557; border: solid 2px #343a40; color:white;min-height:17px;"># Anim.&nbsp;&nbsp;<br>Sembrados</th>
                                    
                                    <th style="background: #555557; border: solid 2px #343a40; color:white;min-height:17px;"># Anim.&nbsp;&nbsp;&nbsp;&nbsp; <br>Proyectados</th>
                                    
                                        <th style="background: #555557; border: solid 2px #343a40; color:white;min-height:17px;">% Superv.&nbsp;</th>
                                     
                                    <th style="background: #555557; border: solid 2px #343a40; color:white;min-height:17px;">Peso <br>Actual </th>
                                 ...
                                 <th style="background: #555557; border: solid 2px #343a40; color:white;min-height:17px;">Inc.&nbsp;&nbsp;&nbsp;&nbsp; </th>
                                     ...
                                     <th style="background: #555557; border: solid 2px #343a40; color:white;min-height:17px;">Peso <br> Proy.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
                                             <th style="background: #555557; border: solid 2px #343a40; color:white;min-height:17px;">  Incremento <br>Miercoles</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center" data-toggle="modal" data-target=".bd-example-modal-sm<?php echo $psm; ?>" style="padding:1px;border: 1px solid #40497C" alt="<?php echo 'piscinas[]'.$value['id_piscina'];?>">
                                            <span class="text-secondary text-xs font-weight-bold" class=" form-control" id="<?php echo 'piscinas[]'.$value['id_piscina'];?>" name="<?php echo 'piscinas[]'.$value['id_piscina'];?>">
                                                ...
                                                <input type="text" class="input2 form-control"  id = "<?php echo 'piscinas[]'.$value['id_piscina']; ?>"  name="<?php echo 'piscinas[]'.$value['id_piscina']; ?>" readonly value="<?php  if($value['id_piscina'] == 22 )
{ echo '17B'; 
...
{ echo $value['id_piscina'];} ?>" readonly style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;">
                                   ...
                                   <?php
                                        ...
                                        <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;">
                                            ...
                                            ?>
                                                ...
                                                <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'densidadess[]'.$value['id_piscina'];?>" name="<?php echo 'densidadess[]'.$value['id_piscina'];?>" step="any" readonly placeholder="0.00" style="" value ="<?php  if ($densidads == 0 || $densidads == null) {
                                                                                                        echo $densidads = 0;
                                                                                                    } else {
                             ...
                             <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;">
                                        ...
                                        ?>
                                              ...
                                              <?php if ($datosatomicos[0]['densidad'] >1){   ?>
                                                                                           <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;color:gray;" class=" form-control" id="<?php echo 'densidades[]'.$value['id_piscina'];?>" name="<?php echo 'densidades[]'.$value['id_piscina'];?>" step="any" readonly  placeholder="0.00" style="" value ="<?php  echo $datosatomicos[0]['densidad']; $densref = $datosatomicos[0]['densidad']; ?>">     
                                             <?php  }else { ?>
                                                                                                <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'densidades[]'.$value['id_piscina'];?>" name="<?php echo 'densidades[]'.$value['id_piscina'];?>" step="any" readonly  placeholder="0.00" style="" value ="<?php  echo $densalterna; $densref = $densalterna; ?>"> 
                                              <?php } ?>
                                        ...
                                        <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'supervive[]'.$value['id_piscina'];?>" name="<?php echo 'supervive[]'.$value['id_piscina'];?>" step="any"  readonly style="" 
                         ...
                         echo substr($datars[0]['tipo'], 0, 14);
                            ...
                            $semanatotal = $datosatomicos[0]['alimento_proyectado'];
                                 ...
                                 <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;color:blue;" class=" form-control" id="<?php echo 'fcv[]'.$value['id_piscina'];?>" name="<?php echo 'fcv[]'.$value['id_piscina'];?>" value="<?php echo $datosatomicos[0]['fcv_proyectado'];?>" step="any"  readonly  placeholder="" style="" onfocus="myFunction(this)">
...
";
                                    ...
                                    <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'fcv_fijo[]'.$key['id_piscina'];?>">
                                        ...
                                        //    }
                                            ?>
                                    <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'fcv_fijo[]'.$key['id_piscina'];?>">
                                            <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;color:blue;" class=" form-control" id="<?php echo 'fcv_proyect[]'.$value['id_piscina'];?>" name="<?php echo 'fcv_proyect[]'.$value['id_piscina'];?>" step="any" readonly 
                 ...
                 $factorTotal = + ($a1/$datosatomicos[0]['ha']*1000)/($datosatomicos[0]['lun'] * $datosatomicos[0]['bw1']) 
                         ...
                         <img id="loadingb" src="../src/img/loader.gif" class="header-brand-img" alt="lavalite" style="display:none; position:absolute;top:512px;right:600px;z-index:9999;width:64px;">
                       </form>
                    </div>
...
{ echo $value['id_piscina'];} ?>" readonly style="background:none;border:0">
                             ...
                             <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;">
                                        ...
                                        ?>
                                                                                        ...
                                                                                        <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'cantidad[]'.$key['id_piscina'];?>">
                                                <input type="number" style = "font-size:15px;padding:0px;margin:0px;border:0px;text-align:center;color:red;" class=" form-control" id="<?php echo 'densidades[]'.$value['id_piscina'];?>" name="<?php echo 'densidades[]'.$value['id_piscina'];?>" step="any"  placeholder="0.00" style="" 
