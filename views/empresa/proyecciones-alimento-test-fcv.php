<?php
    ...
    $sqlbase = "UPDATE proyeccion_alimento_test SET estado = '2' WHERE fecha >='$desde' AND fecha <='$hasta' AND camaronera= '$camaronera' AND estado = '1' ;";
    $querybase = mysqli_query($conexion, $sqlbase);
    $sql = " select * from proyeccion_alimento_test WHERE fecha >='$desde' AND fecha <='$hasta' AND camaronera= '$camaronera' AND estado = '2' ;"; 
...
?>
   ...
   <th style="background: #404e67; color:white; border: solid 2px #343a40;width:4%;">
                            ...
                            <tbody>
                             ...
                             $sql = " select * from proyeccion_alimento_test WHERE fecha >='$desde' AND fecha <='$hasta' AND camaronera= '$camaronera' AND ps= '$psm' AND estado = 2;"; 
...
{ echo $value['id_piscina'];} ?>" readonly style = "padding:0px;margin:0px;border:0px;text-align:center;">
                             ...
                             <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;width:12%;">
                                            <?php
                                            ...
                                            ?>
                                                ...
                                                <input type="number" style = "padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'densidadess[]'.$value['id_piscina'];?>" name="<?php echo 'densidadess[]'.$value['id_piscina'];?>" step="any" readonly placeholder="0.00" style="width:85px;" value ="<?php  if ($densidads == 0 || $densidads == null) {
                                                                                                        echo $densidads = 0;
                                                                                                    } else {
                                        ...
                                        <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;width:10%;">
                                            <?php
                                        ...
                                        if ($currentday <= $data_param[0]['dias'] ){
                                            ...
                                            if($datosatomicos[0]['densidad']>1){

                                        ?>
                                        <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'cantidad[]'.$key['id_piscina'];?>">
                                                <input type="number" style = "padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'densidades[]'.$value['id_piscina'];?>" name="<?php echo 'densidades[]'.$value['id_piscina'];?>" step="any"  placeholder="0.00" style="width:85px;" 
                                                value ="<?php       echo  $datosatomicos[0]['densidad'];$densref =  intval($densidads - ($mor_diaria*$currentday));  ?>">
                                            </span>
                                        
                                        <? } else { ?>
                                         <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'cantidad[]'.$key['id_piscina'];?>">
                                                <input type="number" style = "padding:0px;margin:0px;border:0px;text-align:center;color:red;" class=" form-control" id="<?php echo 'densidades[]'.$value['id_piscina'];?>" name="<?php echo 'densidades[]'.$value['id_piscina'];?>" step="any"  placeholder="0.00" style="width:85px;" 
                                        ...
                                        <?php    if($datosatomicos[0]['densidad']>1){ ?>
                                                <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'cantidad[]'.$key['id_piscina'];?>">
                                                <input type="number" style = "padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'densidades[]'.$value['id_piscina'];?>" name="<?php echo 'densidades[]'.$value['id_piscina'];?>" step="any"  placeholder="0.00"  value ="<?php   
                                                                                         echo   $datosatomicos[0]['densidad'];  $densref = intval($proyecto*10000);      
                                                                                                    ?>">
                                            </span>
                                        <?php } else { ?>
                                                       <span class="text-secondary text-xs font-weight-bold" id="<?php echo 'cantidad[]'.$key['id_piscina'];?>">
                                                <input type="number" style = "padding:0px;margin:0px;border:0px;text-align:center;color:green;" class=" form-control" id="<?php echo 'densidades[]'.$value['id_piscina'];?>" name="<?php echo 'densidades[]'.$value['id_piscina'];?>" step="any"  placeholder="0.00"  value ="<?php   
                                                     echo  $densref = intval($proyecto*10000);            
                                                                                                    ?>">
                                            </span>
                                        <?php } ?>
                                        ...
                                        <input type="number" style = "padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'supervive[]'.$value['id_piscina'];?>" name="<?php echo 'supervive[]'.$value['id_piscina'];?>" step="any"  readonly 
                             ...
                             <input type="text" class="input2 form-control"  id = "<?php echo 'peso[]'.$value['id_piscina']; ?>"  name="<?php echo 'peso[]'.$value['id_piscina']; ?>" readonly value="<?php echo $peso1; ?>" readonly style = "padding:0px;margin:0px;border:0px;text-align:center;">
                                        ...
                                        <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;width:8%;">
                                            <span class="text-warning text-xs font-weight-bold" id="<?php echo 'cantidad[]'.$key['id_piscina'];?>">
                                                <input type="number" style = "padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'crecimientos[]'.$value['id_piscina'];?>" name="<?php echo 'crecimientos[]'.$value['id_piscina'];?>" value ="<?echo $datosatomicos[0]['crecimiento']; ?>" step="any"  placeholder="0.00">
                                            </span>
                                        </td>
                                           ...
                                           <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C" id="<?php echo 'pesofinalestd[]'.$value['id_piscina'];?>" >
                                            ...
                                            <span class="text-secondary text-xs font-weight-bold">
                                 <input type="number" style = "padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'pesofinales[]'.$value['id_piscina'];?>" name="<?php echo 'pesofinales[]'.$value['id_piscina'];?>" value ="<?echo $datosatomicos[0]['peso_proyectado']; ?>" step="any"  readonly placeholder=""  onfocus="myFunction(this)">
  ...
  <!-- cantidad dia lunes -->
                                ...
                                <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C">
                                     ...
                                     <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;width:8%" id="<?php echo 'alimentotd0[]'.$value['id_piscina'];?>" >

                                            <span class="text-secondary text-xs font-weight-bold">
                                 <input type="number" style = "padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'alimento0[]'.$value['id_piscina'];?>" value = "<?php echo $datosatomicos[0]['alimento_proyectado']; ?>" name="<?php echo 'alimento0[]'.$value['id_piscina'];?>" step="any"  readonly placeholder="" style="width:100px;" onfocus="myFunction(this)">
                                                                          <?php 
                            $semanatotal = $datosatomicos[0]['alimento_proyectado'];
                                     ...
                                     <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;width:9%" id="<?php echo 'porcentajetd[]'.$value['id_piscina'];?>" >

                                            <span class="text-secondary text-xs font-weight-bold">                                                                                                                                                          
                                 <input type="number" style = "padding:0px;margin:0px;border:0px;text-align:center;" class=" form-control" id="<?php echo 'porcentaje[]'.$value['id_piscina'];?>" name="<?php echo 'porcentaje[]'.$value['id_piscina'];?>" value="<?php  echo  $semana_percent = number_format((floatval($acum_semanal) / $semanatotal*100),2); ?>" step="any"  readonly  placeholder="" style="width:100px;" onfocus="myFunction(this)">
                                           
                                            </span>

                                         </td>
                                         
                                                                             <td class="align-middle text-center" style="padding:1px;border: 1px solid #40497C;width:9%" id="<?php echo 'fcvtd[]'.$value['id_piscina'];?>" >

                                            <span class="text-secondary text-xs font-weight-bold">
                                 <input type="number" style = "padding:0px;margin:0px;border:0px;text-align:center;color:blue;" class=" form-control" id="<?php echo 'fcv[]'.$value['id_piscina'];?>" name="<?php echo 'fcv[]'.$value['id_piscina'];?>" value="<?php echo $datosatomicos[0]['fcv_proyectado'];?>" step="any"  readonly  placeholder="" style="width:100px;" onfocus="myFunction(this)">
...
";
                 ...
                 $factorTotal = + ($a1/$datosatomicos[0]['ha']*1000)/($datosatomicos[0]['lun'] * $datosatomicos[0]['bw1']) 
                            ...
                            + ($a7/$datosatomicos[0]['ha']*1000)/($datosatomicos[0]['dom'] * $datosatomicos[0]['bw7']);
                                 ...
                                 <td class="align-middle text-center" style="border: solid 0px #343a40; color:white;"  colspan="28">
                         ...
                         <img id="loading" src="../src/img/loader.gif" class="header-brand-img" alt="lavalite" style="display:none;width: 55px; position:absolute;top:512px;right:400px;z-index:9999;">
                       </form>
                    </div>
    <?php
} 
    ...
    var getdias = document.getElementById('getdias[]' + suffix).innerHTML;
     var getantes = document.getElementById('getantes').innerHTML;
       var getdesde = document.getElementById('semini').innerHTML;
        document.getElementById('pesofinalestd[]' + suffix).querySelector('input').value = pesof;
       document.getElementById('supervivetd[]' + suffix).querySelector('input').value = (densidad/siembra)*100;
    //  alert(getantes);
    //    alert(pesof);
    //   alert(masa);
   // alert(has);
